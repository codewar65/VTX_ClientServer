...
65536));return d&65535},fadeScreen=function(a){a?(pageDiv.classList.add("fade"),ovl.dialog=domElement("div",{className:"noselect"},{width:"256px",height:"128px",display:"block",background:"#CCC",color:"#000",border:"2px outset #888",position:"fixed",top:(window.innerHeight-128)/2+"px",left:(pageWidth-256)/2+"px",cursor:"default",fontFamily:"san-serif",fontSize:"12px"}),document.body.appendChild(ovl.dialog),ovl.dialog.appendChild(domElement("input",{type:"button",onclick:ymCancel,value:"Cancel"},{width:"96px",
height:"24px",position:"absolute",bottom:"8px",right:"8px"})),ovl.title=domElement("span",{className:"noselect"},{width:"228px",height:"20px",background:"#039",border:"1px inset #888",position:"absolute",top:"4px",left:"4px",padding:"0px 8px",fontSize:"14px",fontWieght:"bold",color:"white"},"YModem Download"),ovl.dialog.appendChild(ovl.title),ovl.dialog.appendChild(domElement("span",{className:"noselect"},{position:"absolute",top:"32px",left:"12px"},"File:")),ovl.filename=domElement("span",{},{position:"absolute",
top:"32px",left:"80px",width:"172px",overflow:"hidden",textOverflow:"ellipsis"},"{filename}"),ovl.dialog.appendChild(ovl.filename),ovl.dialog.appendChild(domElement("span",{className:"noselect"},{position:"absolute",top:"52px",left:"12px"},"Size:")),ovl.filesize=domElement("span",{},{position:"absolute",top:"52px",left:"80px",width:"172px",overflow:"hidden",textOverflow:"ellipsis"},"{filesize}"),ovl.dialog.appendChild(ovl.filesize),ovl.dialog.appendChild(domElement("span",{className:"noselect"},{position:"absolute",
top:"72px",left:"12px"},"Transferred:")),ovl.transferred=domElement("span",{},{position:"absolute",top:"72px",left:"80px",width:"172px",overflow:"hidden",textOverflow:"ellipsis"},"{transferred}"),ovl.dialog.appendChild(ovl.transferred),setBulbs(),document.getElementById("ulbtn").style.visibility="hidden",document.getElementById("dlbtn").style.visibility="hidden",setTimers(!1),document.body.style.cursor="wait"):(pageDiv.classList.remove("fade"),ovl.dialog&&document.body.removeChild(ovl.dialog),ovl=
{},document.getElementById("ulbtn").style.visibility="visible",document.getElementById("dlbtn").style.visibility="visible",setTimers(!0),document.body.style.cursor="default")},UFT8ArrayToStr=function(a){var b;var d="";var c=a.length;for(b=0;b<c;){var e=a[b++];switch(e>>>4){case 0:case 1:case 2:case 3:case 4:case 5:case 6:case 7:d+=String.fromCharCode(e);break;case 12:case 13:var f=a[b++];d+=String.fromCharCode((e&31)<<6|f&63);break;case 14:f=a[b++];var h=a[b++];d+=String.fromCharCode((e&15)<<12|(f&
63)<<6|(h&63)<<0)}}return d},initDisplay=function(){var a;hotspotHoverAttr=524543;hotspotClickAttr=255;if(a=document.getElementById("vtxclient")){pageDiv=domElement("div",{id:"vtxpage",className:"noselect"});textDiv=domElement("div",{id:"vtxtext",className:"noselect"});pageDiv.appendChild(textDiv);a.appendChild(pageDiv);textPos=getElementPosition(textDiv);getDefaultFontSize();crtWidth=colSize*crtCols;codePageData[codePage]||codePageAKAs[codePage]&&(codePage=codePageAKAs[codePage]);if(cbm){conFontNum=
0;switch(vtxdata.codePage){case "VIC20":conFont[0]="VIC200";conFont[1]="VIC201";cbmColors=vic20Colors;break;case "C64":conFont[0]="C640";conFont[1]="C641";cbmColors=c64Colors;break;case "C128":conFont[0]="C1280",conFont[1]="C1281",cbmColors=c128Colors}conFontCP[0]="RAW";conFontCP[1]="RAW"}else if(atari)conFontNum=0,conFont[0]="ATARI",conFontCP[0]="RAW";else{for(a=conFontNum=0;10>a;a++)conFont[a]=fontName,conFontCP[a]=codePage;for(a=10;13>a;a++)conFont[a]=fontName,conFontCP[a]="TELETEXT"}pageDiv.style.width=
crtWidth*xScale+"px";pagePos=getElementPosition(pageDiv);pageLeft=pagePos.left;pageTop=pagePos.top;a=document.createElement("style");a.type="text/css";var b="#vtxpage { font-family: "+fontName+"; font-size: "+fontSize+"px; min-height: "+(fontSize*vtxdata.crtRows).toString()+"px; margin: 0px auto; padding: 0px; border: 0px; overflow: hidden; text-overflow: clip; z-index: 0; position: relative;}\n#vtxtext { width: 100%; margin: 0px; padding: 0px; border: 0px; overflow: hidden; text-overflow: clip; z-index: 10; position: relative;}\n.vtx { position: relative; left: 0px; line-height: 1em; height: 1em; vertical-align: top; overflow: hidden; text-overflow: clip;}\n.fade { opacity: .5; background: #000055;}\n.noselect { -webkit-touch-callout: none; -webkit-user-select: none; -khtml-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none;}\n.marquee { animation: marquee 12s linear infinite; } @keyframes marquee { 0% { transform: translate( "+
...
1;soundBell.preload="auto";soundBell.load();a=pageDiv.parentNode;cbm?(a.style["background-color"]=cbmColors[pageAttr>>>8&15],pageDiv.style["background-color"]=cbmColors[pageAttr&15]):atari?(a.style["background-color"]=atariColors[pageAttr>>>8&1],pageDiv.style["background-color"]=atariColors[pageAttr&1]):(a.style["background-color"]=ansiColors[pageAttr>>>8&255],pageDiv.style["background-color"]=ansiColors[pageAttr&255]);pageWidth=elPage.clientWidth;crsrBlink=shiftState=ctrlState=altState=capState=
numState=scrState=!1;cellBlinkFast=cellBlinkSlow=!0;crsrRow=crsrCol=0;crsrDraw();setTimers(!0);crsrRow=crsrCol=0;termState=TS_OFFLINE;ctrlDiv=domElement("div",{id:"ctrls"},{width:"24px",height:"164px",position:"absolute",top:textPos.top+"px",left:6+textPos.left+crtWidth*xScale+"px"});ctrlDiv.appendChild(domElement("img",{src:vtxPath+"os0.png",id:"osbulb",onclick:termConnect,width:24,height:24,title:"Connect/Disconnect"},{cursor:"pointer"}));ctrlDiv.appendChild(domElement("img",{src:vtxPath+"cl0.png",
id:"clbulb",width:24,height:24,title:"CapsLk"}));ctrlDiv.appendChild(domElement("img",{src:vtxPath+"nl0.png",id:"nlbulb",width:24,height:24,title:"NumLk"}));ctrlDiv.appendChild(domElement("img",{src:vtxPath+"sl0.png",id:"slbulb",width:24,height:24,title:"ScrLk"}));ctrlDiv.appendChild(domElement("img",{src:vtxPath+"ul0.png",id:"ulbtn",onclick:ymSendStart,width:24,height:24,title:"YModem Upload"},{cursor:"pointer"}));ctrlDiv.appendChild(domElement("img",{src:vtxPath+"dl0.png",id:"dlbtn",onclick:ymRecvStart,
width:24,height:24,title:"YModem Download"},{cursor:"pointer"}));pageDiv.parentNode.appendChild(ctrlDiv);audioEl=domElement("audio",{id:"vtxaudio",preload:"none",volume:"0.25",src:"/;"},{width:"0px",height:"0px"});pageDiv.appendChild(audioEl);conBufferOut(initStr);if(vtxdata.autoConnect&&0<vtxdata.autoConnect)termConnect();else switch(vtxdata.term){case "PETSCII":conStrOut("\u000evtx tERMINAL cLIENT\r");conStrOut("vERSION 0.9\r");conStrOut("2017 dAN mECKLENBURG jR.\r");conStrOut("GITHUB.COM/CODEWAR65/vtx\u00a4cLIENTsERVER\r");
...
b.toString();break;default:for(d="",a=0;a<b.length;a++)d+=String.fromCharCode(b[a])}conBufferOut(d);break;case TS_YMR_START:case TS_YMR_GETPACKET:b=ymRStateMachine(b);0<b.length&&conBufferOut(d);break;case TS_YMS_START:case TS_YMS_PUTPACKET:case TS_YMS_PUTWAIT:b=ymSStateMachine(b),0<b.length&&conBufferOut(d)}},ws.onopen=function(){vtxdata.telnet&&tnInit();termState=TS_NORMAL;setBulbs()},ws.onclose=function(){conBaud=0;cbm?conBufferOut("\r\rDISCONNECTED.\r"):atari?conBufferOut("\u009b\u009bDisconnected.\u009b"):
conBufferOut("\r\n\r\n\u001b[#9\u001b[0;91mDisconnected.\r\n");document.body.style.cursor="default";audioEl&&audioEl.pause();termState=TS_OFFLINE;setBulbs()},ws.onerror=function(a){cbm?conBufferOut("\r\rERROR : "+a.reason.toUpper()+"\r"):atari?conBufferOut("\u009b\u009bError : "+a.reason()+"\tB"):conBufferOut("\r\n\r\n\u001b[#9\u001b[0;91mError : "+a.reason+"\r\n");setBulbs()}):ws.close()},newCrsr=function(){var a=["0%","10%","25%","100%"];if(null==crsr){crsr=domElement("div",{},{position:"absolute",
display:"block",zIndex:"999"});var b=domElement("div",{id:"crsr"},{position:"absolute",display:"block",bottom:"0px",left:"0px"});crsr.appendChild(b);pageDiv.appendChild(crsr)}else b=crsr.firstChild;var d=getCrsrAttrOrientation(crsrAttr);var c=getCrsrAttrSize(crsrAttr);switch(d){case 0:b.style.width="100%";b.style.height=a[c];break;default:b.style.height="100%",b.style.width=a[c]}a=getCrsrAttrColor(crsrAttr);b.style["background-color"]=cbm?cbmColors[a&15]:atari?atariColors[a&1]:ansiColors[a]},paste=
...
null!=irqCheckResize&&clearInterval(irqCheckResize),null!=irqCursor&&clearInterval(irqCursor),null!=irqBlink&&clearInterval(irqBlink),irqBlink=irqCursor=irqCheckResize=irqWriteBuffer=null)},setBulbs=function(){var a=document.getElementById("osbulb");termState==TS_OFFLINE?(a.src=vtxPath+"os0.png",a.title="Connect"):(a.src=vtxPath+"os1.png",a.title="Disconnect");document.getElementById("clbulb").src=vtxPath+(capState?"cl1":"cl0")+".png";document.getElementById("nlbulb").src=vtxPath+(numState?"nl1":
"nl0")+".png";document.getElementById("slbulb").src=vtxPath+(scrState?"sl1":"sl0")+".png";termState==TS_NORMAL?(a=document.getElementById("ulbtn"),a.src=vtxPath+"ul1.png",a.style.visibility="visible",a=document.getElementById("dlbtn"),a.src=vtxPath+"dl1.png",a.style.visibility="visible"):termState==TS_OFFLINE?(a=document.getElementById("ulbtn"),a.src=vtxPath+"ul0.png",a.style.visibility="visible",a=document.getElementById("dlbtn"),a.src=vtxPath+"dl0.png",a.style.visibility="visible"):(document.getElementById("ulbtn").style.visibility=
"hidden",document.getElementById("dlbtn").style.visibility="hidden")},fitSVGToDiv=function(a){var b=this.parentNode.getBoundingClientRect();a=b.width;b=b.height;var d=this.naturalWidth;var c=this.naturalHeight;this.style["transform-origin"]="top left";this.style.transform="scale("+a/c+","+b/d+")";this.style.visibility="visible"},expandToRow=function(a){if(a>=conRowAttr.length){for(;a>getMaxRow();)textDiv.appendChild(createNewRow()),conRowAttr[conRowAttr.length]=2883584,conCellAttr[conCellAttr.length]=
[],conText[conText.length]="";trimHistory()}},expandToCol=function(a,b){for(;conText[a].length<b;)conText[a]+=" ";for(;conCellAttr[a].length<b;)conCellAttr[a][conCellAttr[a].length]=defCellAttr},brightenRGB=function(a,b){if("transparent"==a)return a;var d=htoi(a.substring(1));var c=d>>>16&255;var e=d>>>8&255;d&=255;0>b?(b+=1,c*=b,e*=b,d*=b):(c=(255-c)*b+c,e=(255-e)*b+e,d=(255-d)*b+d);c=Math.floor(c)&255;e=Math.floor(e)&255;d=Math.floor(d)&255;return"#"+itoh((c<<16)+(e<<8)+d,6)},drawMosaicBlock=function(a,
b,d,c,e){var f,h,k=1,l=Math.floor(d/2),g=Math.floor(c/3),m,r=0;e=e?-1:0;d-=2*l;c-=3*g;b-=32;31<b&&(b-=32);for(h=0;3>h;h++){for(f=m=0;2>f;f++)b&k&&a.fillRect(m,r,l+(f?d:0)+e,g+(2==h?c:0)+e),m+=l,k<<=1;r+=g}},renderCell=function(a,b,d,c){d=d||0;var e=(c=c||!1)?-1:0;if(!(a+e>conRowAttr.length||b>=conText[a+e].length)){var f=getRowAttrHeight(conRowAttr[a+e])/100;var h=getRowAttrWidth(conRowAttr[a+e])/100;var k=xScale*colSize*h;var l=k*b;if(!(l>k*crtCols)||conRowAttr[a]&A_ROW_MARQUEE){var g=getRowElement(a);
var m=fontSize*f;var r=.1*m;var p=g.firstChild;p||(p=domElement("canvas",{width:crtCols*k,height:m+16},{zIndex:"50"}),g.appendChild(p));g=p.getContext("2d");p=conText[a+e].charAt(b);b=conCellAttr[a+e][b];1==d?b=hotspotHoverAttr:2==d&&(b=hotspotClickAttr);d=b&255;var n=b>>>8&255;e=(b&A_CELL_FONT_MASK)>>>28&15;var q=b&A_CELL_BOLD;modeNoBold&&(q=0);var v=b&(A_CELL_BLINKSLOW|A_CELL_BLINKFAST);modeBoldFont&&q&&(e=1);modeBlinkFont&&v&&(e=2);modeBoldFont&&q&&modeBlinkFont&&v&&(e=3);if(b&A_CELL_REVERSE){var w=
d;d=n;n=w}cbm||atari||modeVTXANSI||(q&&8>d&&(d+=8),q=!1);modeBlinkBright&&8>n&&v&&(n+=8,b&=~(A_CELL_BLINKSLOW|A_CELL_BLINKFAST));cbm||atari||(0==d&&(d=16),0!=n||modeVTXANSI||(n=16));9608==p.charCodeAt(0)&&(p=" ",n=d);g.save();g.beginPath();g.rect(l,0,k,m);g.clip();cbm?(g.fillStyle=cbmColors[n],g.fillRect(l,0,k,m)):atari?(g.fillStyle=atariColors[n],g.fillRect(l,0,k,m)):0<n?(g.fillStyle=ansiColors[n],g.fillRect(l,0,k,m)):g.clearRect(l,0,k,m);n=!0;if(b&A_CELL_BLINKSLOW&&cellBlinkSlow||b&A_CELL_BLINKFAST&&
cellBlinkFast)modeNoBlink||(n=!1);switch(conRowAttr[a]&A_ROW_DISPLAY_MASK){case A_ROW_DISPLAY_NORMAL:a=b&A_CELL_DISPLAY_MASK;switch(a){case A_CELL_DISPLAY_NORMAL:var t=0;var u=1;break;case A_CELL_DISPLAY_CONCEAL:n=!1;break;case A_CELL_DISPLAY_TOP:t=0;u=2;break;case A_CELL_DISPLAY_BOTTOM:t=-m,u=2}break;case A_ROW_DISPLAY_CONCEAL:n=!1;break;case A_ROW_DISPLAY_TOP:t=0;u=2;break;case A_ROW_DISPLAY_BOTTOM:t=-m,u=2}if(n){g.fillStyle=b&A_CELL_FAINT?brightenRGB(ansiColors[d],-.33):cbm?cbmColors[d]:atari?
atariColors[d]:ansiColors[d];a=-1;if(11==e||12==e){if(" "<=p&&"?">=p||"`"<=p&&"\u007f">=p)a=e-11;g.font=(q?"bold ":"")+fontSize+"px "+conFont[e]}else g.font=cbm?(q?"bold ":"")+fontSize+"px "+conFont[conFontNum]:(q?"bold ":"")+fontSize+"px "+conFont[e];g.textAlign="start";g.textBaseline="top";b&A_CELL_SHADOW&&(g.shadowColor="#000000",g.shadowOffsetX=m/rowSize,g.shadowOffsetY=m/rowSize);n=q=g.shadowBlur=0;b&A_CELL_ITALICS&&(q=-.125,n=1);c&&(t=-m,u=2);-1==a&&(p=String.fromCharCode(getUnicode(conFontCP[e],
