...
(a.style["background-color"]=cbmColors[pageAttr>>>8&15],pageDiv.style["background-color"]=cbmColors[pageAttr&15]):atari?(a.style["background-color"]=atariColors[pageAttr>>>8&1],pageDiv.style["background-color"]=atariColors[pageAttr&1]):(a.style["background-color"]=ansiColors[pageAttr>>>8&255],pageDiv.style["background-color"]=ansiColors[pageAttr&255]);pageWidth=elPage.clientWidth;crsrBlink=shiftState=ctrlState=altState=capState=numState=scrState=!1;cellBlinkFast=cellBlinkSlow=!0;crsrRow=crsrCol=0;
crsrDraw();elPage=document.getElementsByTagName("html")[0];setTimers(!0);crsrRow=crsrCol=0;textPos=textDiv.getBoundingClientRect();termState=TS_OFFLINE;ctrlDiv=domElement("div",{id:"ctrls"},{width:"24px",height:"164px",position:"fixed",top:textPos.top+"px",left:6+textPos.left+crtWidth*xScale+"px"});ctrlDiv.appendChild(domElement("img",{src:vtxPath+"os0.png",id:"osbulb",onclick:termConnect,width:24,height:24,title:"Connect/Disconnect"},{cursor:"pointer"}));ctrlDiv.appendChild(domElement("img",{src:vtxPath+
"cl0.png",id:"clbulb",width:24,height:24,title:"CapsLk"}));ctrlDiv.appendChild(domElement("img",{src:vtxPath+"nl0.png",id:"nlbulb",width:24,height:24,title:"NumLk"}));ctrlDiv.appendChild(domElement("img",{src:vtxPath+"sl0.png",id:"slbulb",width:24,height:24,title:"ScrLk"}));ctrlDiv.appendChild(domElement("img",{src:vtxPath+"ul0.png",id:"ulbtn",onclick:ymSendStart,width:24,height:24,title:"YModem Upload"},{cursor:"pointer"}));ctrlDiv.appendChild(domElement("img",{src:vtxPath+"dl0.png",id:"dlbtn",onclick:ymRecvStart,
width:24,height:24,title:"YModem Download"},{cursor:"pointer"}));pageDiv.appendChild(ctrlDiv);audio=domElement("audio",{id:"vtxaudio",preload:"none",volume:"0.25",src:"/;"},{width:"0px",height:"0px"});pageDiv.appendChild(audio);conBufferOut(initStr);if(vtxdata.autoConnect&&0<vtxdata.autoConnect)termConnect();else switch(vtxdata.term){case "PETSCII":conStrOut("\u000evtx tERMINAL cLIENT\r");conStrOut("vERSION 0.9\r");conStrOut("2017 dAN mECKLENBURG jR.\r");conStrOut("GITHUB.COM/CODEWAR65/vtx\u00a4cLIENTsERVER\r");
...
a.altKey;if(!(termState>TS_NORMAL)){var d=(shiftState?1:0)+(ctrlState?2:0)+(altState?4:0);between(b,65,90)&&2>d&&capState&&(d^=1);cbm&&between(b,65,90)&&(d^=1);d=keyVals[d][b];if(null==d||"function"==typeof d&&(d=d(),null==d))return a.returnValue=!0;if("string"==typeof d)return sendData(d),a.preventDefault(),a.returnValue=!1;if("number"==typeof d){if(0==d)return a.preventDefault(),a.returnValue=!0;if(0>d){switch(d){case DO_CAPLK:capState=!capState;setBulbs();break;case DO_NUMLK:numState=!numState;
setBulbs();break;case DO_SCRLK:scrState=!scrState;setBulbs();break;default:return}a.preventDefault();return a.returnValue=!1}if(0<d)return sendData(d),a.preventDefault(),a.returnValue=!1}}},keyUp=function(a){a=a||window.event;crsr.style.display="block";shiftState=a.shiftKey;ctrlState=a.ctrlKey;altState=a.altKey},click=function(a){var b,d;a=a||window.event;shiftState=a.shiftKey;ctrlState=a.ctrlKey;altState=a.altKey;if(!(termState>TS_NORMAL)&&(d=getHotSpot(a))){for(b=0;b<d.height;b++)for(a=0;a<d.width;a++)renderCell(d.row+
b,d.col+a,d.hilite?2:0);switch(d.type){case 0:sendData(d.val);break;case 1:a=window.open(d.val,"_blank"),a.focus()}}},mouseMove=function(a){var b,d;a=a||window.event;shiftState=a.shiftKey;ctrlState=a.ctrlKey;altState=a.altKey;if(!(termState>TS_NORMAL)){if(d=getHotSpot(a)){if(lastHotSpot!=d){if(lastHotSpot)for(b=0;b<lastHotSpot.height;b++)for(a=0;a<lastHotSpot.width;a++)renderCell(lastHotSpot.row+b,lastHotSpot.col+a);for(b=0;b<d.height;b++)for(a=0;a<d.width;a++)renderCell(d.row+b,d.col+a,d.hilite?
1:0)}document.body.style.cursor="pointer"}else{if(lastHotSpot)for(b=0;b<lastHotSpot.height;b++)for(a=0;a<lastHotSpot.width;a++)renderCell(lastHotSpot.row+b,lastHotSpot.col+a);document.body.style.cursor="default"}lastHotSpot=d}},mouseDown=function(a){a=a||window.event;shiftState=a.shiftKey;ctrlState=a.ctrlKey;altState=a.altKey},mouseUp=function(a){a=a||window.event;shiftState=a.shiftKey;ctrlState=a.ctrlKey;altState=a.altKey},getHotSpot=function(a){var b;if(b=getMouseCell(a))for(a=0;a<conHotSpots.length;a++){var d=
conHotSpots[a];if(between(b.row,d.row,d.row+d.height-1)&&between(b.col,d.col,d.col+d.width-1))return conHotSpots[a]}return null},getMouseCell=function(a){var b=a.clientX;var d=a.clientY+0;var c=textPos.top;if(d>=c&&between(b,textPos.left,textPos.left+crtWidth-1))for(a=0;a<conRowAttr.length;a++){var e=getRowAttrHeight(conRowAttr[a])/100;var f=getRowAttrWidth(conRowAttr[a])/100;e=Math.round(fontSize*e);if(between(d,c,c+e-1))return b=(b-textPos.left)/(xScale*colSize*f),{row:a,col:Math.floor(b)};c+=e}return null},
redrawFont=function(a){var b,d;a=conFont.indexOf(a);if(0<=a)for(b=conRowAttr.length-1;0<=b;b--)for(d=conCellAttr[b].length-1;0<=d;d--){var c=(conCellAttr[b][d]&A_CELL_FONT_MASK)>>>28;c==a&&renderCell(b,d,0,!1)}},loadSingleFont=function(a){var b,d=document.getElementsByTagName("head")[0];var c=vtxFonts.indexOf(a);if(0<=c&&!vtxFontsLoaded[c]){var e='@font-face {\r\n   font-family: "'+a+'";   src: url("'+vtxPath+a+'.woff") format("woff"); }\r\n';(b=document.getElementById("vtxfonts"))?b.innerHTML+=e:
b=domElement("style",{type:"text/css"},{},e);d.appendChild(b);var f=domElement("div",{},{fontFamily:a+', "AdobeBlank"',fontSize:"24px",fontWeight:"normal",color:"transparent",display:"inline-block",border:"0px",padding:"0px",margin:"0px"},"Test 1..2..3..");document.body.appendChild(f);var h=setInterval(function(){32<f.offsetWidth&&(vtxFontsLoaded[c]=!0,document.body.removeChild(f),clearInterval(h),setTimeout(function(){redrawFont(a)},250))},250)}},bootVTX2=function(){for(var a=document.getElementsByTagName("title")[0],
b=document.getElementsByTagName("head")[0];!vtxdata;);a?a.innerText&&""!=a.innerText||(a.innerText=vtxdata.sysName):b.appendChild(domElement("title",{},{},vtxdata.sysName));window.setTimeout(initDisplay,100)},bootVTX1=function(){var a,b;document.getElementsByTagName("title");document.getElementsByTagName("head");var d=[];vtxFontsLoaded=Array(vtxFonts.length);vtxFontsLoaded.fill(!1);var c=[];switch(vtxdata.term){case "PETSCII":switch(vtxdata.codePage){case "VIC20":c.push("VIC200");c.push("VIC201");
break;case "C128":c.push("C1280");c.push("C1281");break;default:c.push("C640"),c.push("C641")}break;case "ATASCII":c.push("ATARI");break;default:c.push("UVGA16")}var e=document.getElementById("vtxfonts");var f="";var h=0;for(b=c.length;h<b;h++)f+='@font-face {\r\n   font-family: "'+c[h]+'";   src: url("'+vtxPath+c[h]+'.woff") format("woff"); }\r\n';e.innerHTML+=f;h=0;for(b=c.length;h<b;h++)d[h]=domElement("div",{},{fontFamily:c[h]+', "AdobeBlank"',fontSize:"24px",fontWeight:"normal",color:"transparent",
display:"inline-block",border:"0px",padding:"0px",margin:"0px"},"Test 1..2..3.."),document.body.appendChild(d[h]);var k=setInterval(function(){var b,e=c.length;for(b=c.length-1;0<=b;b--)if(12<d[b].offsetWidth){for(a=0;a<vtxFonts.length;a++)if(vtxFonts[a]==c[b]){vtxFontsLoaded[a]=!0;break}e--}if(0==e){for(b=c.length-1;0<=b;b--)document.body.removeChild(d[b]);clearInterval(k);bootVTX2()}},50)},bootVTX=function(){var a,b=document.getElementsByTagName("head")[0];vtxPath="";var d=document.getElementsByTagName("script");
for(a=d.length-1;0<=a;a--)if(0<=d[a].src.toLowerCase().indexOf("vtxclient")){a=d[a].src.split("?")[0];vtxPath=a.split("/").slice(0,-1).join("/")+"/";break}a=domElement("style",{type:"text/css",id:"vtxfonts"},{},'@font-face { \n  font-family: "AdobeBlank";   src: url("'+vtxPath+'AdobeBlank.woff") format("woff"); }\n');b.appendChild(a);var c=domElement("div",{},{fontFamily:'"AdobeBlank", sans-serif',fontSize:"24px",fontWeight:"normal",color:"transparent",display:"inline-block",border:"0px",padding:"0px",
margin:"0px"},"Test 1..2..3..");document.body.appendChild(c);var e=setInterval(function(){32>c.offsetWidth&&(document.body.removeChild(c),clearInterval(e),bootVTX1())},50)},between=function(a,b,d){return b<=a&&a<=d},minMax=function(a,b,d,c){c=void 0===c?null:c;null==c?(a<b&&(a=b),a>d&&(a=d)):(a<b&&(a=c),a>d&&(a=c));return a},int=function(a){return parseInt(a,10)},domElement=function(a,b,d,c){b=void 0===b?null:b;d=void 0===d?null:d;c=void 0===c?null:c;a=document.createElement(a);var e;if(b)for(e in b)a[e]=
b[e];if(d)for(e in d)a.style[e]=d[e];c&&a.appendChild(document.createTextNode(c));return a},addListener=function(a,b,d){a.addEventListener?a.addEventListener(b,d,!1):a.attachEvent("on"+b,d)},ansiColors="transparent #AA0000 #00AA00 #AA5500 #0000AA #AA00AA #00AAAA #AAAAAA #555555 #FF5555 #55FF55 #FFFF55 #5555FF #FF55FF #55FFFF #FFFFFF #000000 #00005F #000087 #0000AF #0000D7 