...
b,d,c,e){var f,h,k=1,m=Math.floor(d/2),g=Math.floor(c/3),l,r=0;e=e?-1:0;d-=2*m;c-=3*g;b-=32;31<b&&(b-=32);for(h=0;3>h;h++){for(f=l=0;2>f;f++)b&k&&a.fillRect(l,r,m+(f?d:0)+e,g+(2==h?c:0)+e),l+=m,k<<=1;r+=g}},renderCell=function(a,b,d,c){d=(void 0===d?0:d)||0;var e=(c=(void 0===c?!1:c)||!1)?-1:0;if(!(a+e>conRowAttr.length||b>=conText[a+e].length)){var f=getRowAttrHeight(conRowAttr[a+e])/100;var h=getRowAttrWidth(conRowAttr[a+e])/100;var k=xScale*colSize*h;var m=k*b;if(!(m>k*crtCols)||conRowAttr[a]&
A_ROW_MARQUEE){var g=getRowElement(a);var l=fontSize*f;var r=.1*l;var p=g.firstChild;p||(p=domElement("canvas",{width:crtCols*k,height:l+16},{zIndex:"50"}),g.appendChild(p));g=p.getContext("2d");p=conText[a+e].charAt(b);b=conCellAttr[a+e][b];1==d?b=hotspotHoverAttr:2==d&&(b=hotspotClickAttr);d=b&255;var n=b>>>8&255;e=(b&A_CELL_FONT_MASK)>>>28&15;var q=b&A_CELL_BOLD;modeNoBold&&(q=0);var v=b&(A_CELL_BLINKSLOW|A_CELL_BLINKFAST);modeBoldFont&&q&&(e=1);modeBlinkFont&&v&&(e=2);modeBoldFont&&q&&modeBlinkFont&&
v&&(e=3);if(b&A_CELL_REVERSE){var w=d;d=n;n=w}cbm||atari||modeVTXANSI||(q&&8>d&&(d+=8),q=!1);modeBlinkBright&&8>n&&v&&(n+=8,b&=~(A_CELL_BLINKSLOW|A_CELL_BLINKFAST));cbm||atari||(0==d&&(d=16),0!=n||modeVTXANSI||(n=16));9608==p.charCodeAt(0)&&(p=" ",n=d);g.save();g.beginPath();g.rect(m,0,k,l);g.clip();cbm?(g.fillStyle=cbmColors[n],g.fillRect(m,0,k,l)):atari?(g.fillStyle=atariColors[n],g.fillRect(m,0,k,l)):0<n?(g.fillStyle=ansiColors[n],g.fillRect(m,0,k,l)):g.clearRect(m,0,k,l);n=!0;if(b&A_CELL_BLINKSLOW&&
cellBlinkSlow||b&A_CELL_BLINKFAST&&cellBlinkFast)modeNoBlink||(n=!1);switch(conRowAttr[a]&A_ROW_DISPLAY_MASK){case A_ROW_DISPLAY_NORMAL:a=b&A_CELL_DISPLAY_MASK;switch(a){case A_CELL_DISPLAY_NORMAL:var t=0;var u=1;break;case A_CELL_DISPLAY_CONCEAL:n=!1;break;case A_CELL_DISPLAY_TOP:t=0;u=2;break;case A_CELL_DISPLAY_BOTTOM:t=-l,u=2}break;case A_ROW_DISPLAY_CONCEAL:n=!1;break;case A_ROW_DISPLAY_TOP:t=0;u=2;break;case A_ROW_DISPLAY_BOTTOM:t=-l,u=2}if(n){g.fillStyle=b&A_CELL_FAINT?brightenRGB(ansiColors[d],
...
p.charCodeAt(0))));g.setTransform(xScale*h,0,xScale*q,u*f,m+xScale*n,t);b&A_CELL_OUTLINE?(g.strokeStyle=ansiColors[d],g.lineWidth=1,g.strokeText(p,0,0)):0<=a?drawMosaicBlock(g,p.charCodeAt(0),k/h,l,a):g.fillText(p,0,0);b&A_CELL_UNDERLINE&&g.fillRect(0,l-r,k,r);b&A_CELL_STRIKETHROUGH&&g.fillRect(0,(l+r)/2,k,r)}g.restore()}}},renderAll=function(){var a,b;for(a=0;a<conRowAttr.length;a++)for(b=0;b<conCellAttr[a].length;b++)renderCell(a,b)},redrawRow=function(a){var b;expandToRow(a);var d=conText[a].length;
...
var d=[];vtxFontsLoaded=Array(vtxFonts.length);vtxFontsLoaded.fill(!1);var c=[];switch(vtxdata.term){case "PETSCII":switch(vtxdata.codePage){case "VIC20":c.push("VIC200");c.push("VIC201");break;case "C128":c.push("C1280");c.push("C1281");break;default:c.push("C640"),c.push("C641")}break;case "ATASCII":c.push("ATARI");break;default:c.push("UVGA16")}var e=document.getElementById("vtxfonts");var f="";var h=0;for(b=c.length;h<b;h++)f+='@font-face {\r\n   font-family: "'+c[h]+'";   src: url("'+vtxPath+
c[h]+'.woff") format("woff"); }\r\n';e.innerHTML+=f;h=0;for(b=c.length;h<b;h++)d[h]=domElement("div",{},{fontFamily:c[h]+', "AdobeBlank"',fontSize:"24px",fontWeight:"normal",color:"transparent",display:"inline-block",border:"0px",padding:"0px",margin:"0px"},"Test 1..2..3.."),document.body.appendChild(d[h]);var k=setInterval(function(){var b,e=c.length;for(b=c.length-1;0<=b;b--)if(12<d[b].offsetWidth){for(a=0;a<vtxFonts.length;a++)if(vtxFonts[a]==c[b]){vtxFontsLoaded[a]=!0;break}e--}if(0==e){for(b=
c.length-1;0<=b;b--)document.body.removeChild(d[b]);clearInterval(k);bootVTX2()}},50)},bootVTX=function(){var a,b=document.getElementsByTagName("head")[0];vtxPath="";var d=document.getElementsByTagName("script");for(a=d.length-1;0<=a;a--)if(0<=d[a].src.toLowerCase().indexOf("vtxclient")){a=d[a].src.split("?")[0];vtxPath=a.split("/").slice(0,-1).join("/")+"/";break}a=domElement("style",{type:"text/css",id:"vtxfonts"},{},'@font-face { \n  font-family: "AdobeBlank";   src: url("'+vtxPath+'AdobeBlank.woff") format("woff"); }\n');
b.appendChild(a);var c=domElement("div",{},{fontFamily:'"AdobeBlank", sans-serif',fontSize:"24px",fontWeight:"normal",color:"transparent",display:"inline-block",border:"0px",padding:"0px",margin:"0px"},"Test 1..2..3..");document.body.appendChild(c);var e=setInterval(function(){32>c.offsetWidth&&(document.body.removeChild(c),clearInterval(e),bootVTX1())},50)},between=function(a,b,d){return b<=a&&a<=d},minMax=function(a,b,d,c){c=void 0===c?null:c;null==c?(a<b&&(a=b),a>d&&(a=d)):(a<b&&(a=c),a>d&&(a=
c));return a},int=function(a){return parseInt(a,10)},domElement=function(a,b,d,c){b=void 0===b?null:b;d=void 0===d?null:d;c=void 0===c?null:c;a=document.createElement(a);var e;if(b)for(e in b)a[e]=b[e];if(d)for(e in d)a.style[e]=d[e];c&&a.appendChild(document.createTextNode(c));return a},addListener=function(a,b,d){a.addEventListener?a.addEventListener(b,d,!1):a.attachEvent("on"+b,d)},ansiColors="transparent #AA0000 #00AA00 #AA