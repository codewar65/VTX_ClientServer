...
crsrCol,a,cellAttr);crsrCol++;modeAutoWrap?crsrCol==colsOnRow(crsrRow)&&(crsrCol=0,crsrRow++):crsrCol>=crtCols&&crsrCol--;lastChar=a},scrollDown=function(){var a;if(modeRegionOrigin){var b=regionTopRow;var d=regionBottomRow}else b=0,d=conRowAttr.length-1;expandToRow(crtRows);for(a=d;a>b;a--)conText[a]=conText[a-1],conCellAttr[a]=conCellAttr[a-1],conRowAttr[a]=conRowAttr[a-1],redrawRow(a);conText[b]="";conCellAttr[b]=[];conRowAttr[b]=defRowAttr;redrawRow(b);clearHotSpotsRow(d,0,999);moveHotSpotsRows(b,
d-1,1)},scrollUp=function(){var a;if(modeRegionOrigin){var b=regionTopRow;var d=regionBottomRow}else b=0,d=conRowAttr.length-1;expandToRow(crtRows);for(a=b;a<d;a++)conText[a]=conText[a+1],conCellAttr[a]=conCellAttr[a+1],conRowAttr[a]=conRowAttr[a+1],redrawRow(a);conText[d]="";conCellAttr[d]=[];conRowAttr[d]=defRowAttr;redrawRow(d);clearHotSpotsRow(b,0,999);moveHotSpotsRows(b+1,d,-1)},moveHotSpotsRows=function(a,b,d){var c;for(c=conHotSpots.length-1;0<=c;c--){var e=conHotSpots[c];between(e.row,a,b)&&
(e.row+=d)}},moveHotSpotsRow=function(a,b,d,c){var e;for(e=conHotSpots.length-1;0<=e;e--){var f=conHotSpots[e];f.row==a&&between(f.col,b,d)&&(f.col+=c)}},clearHotSpotsRows=function(a,b){var d;for(d=conHotSpots.length-1;0<=d;d--){var c=conHotSpots[d];between(c.row,a,b)&&conHotSpots.splice(d,1)}},clearHotSpotsRow=function(a,b,d){var c;for(c=conHotSpots.length-1;0<=c;c--){var e=conHotSpots[c];e.row==a&&e.col>=b&&e.col<=d&&conHotSpots.splice(c,1)}},conPutChar=function(a,b,d,c){expandToRow(a);expandToCol(a,
b);conText[a]=conText[a].splice(b,1,String.fromCharCode(d));conCellAttr[a][b]=c;renderCell(a,b)},sendData=function(a){var b;if("string"===typeof a){var d=a;var c=d.length;a=new Uint8Array(c);for(b=0;b<c;b++)a[b]=d.charCodeAt(b)}else"number"===typeof a&&(d=String.fromCharCode(a),a=new Uint8Array([a]));if(!(a instanceof Uint8Array))throw"Invalid data in sendData().";if(vtxdata.telnet&&0<=a.indexOf(255)){var e=[];for(b=0;0<=(c=a.indexOf(255));)e.push(a.slice(0,c)),b+=c,e.push(new Uint8Array([255,255])),
b+=2,a=a.slice(c+1);b+=a.length;e.push(a);a=new Uint8Array(b);for(b=c=0;b<e.length;b++)a.set(e[b],c),c+=e[b].length}ws&&1==ws.readyState&&termState!=TS_OFFLINE?ws.send(a.buffer):(conBufferOut(d),crsrDraw())},getUnicode=function(a,b){if("UTF8"==a)return b;var d=0,c=codePageData[a]||codePageData[codePageAKAs[a]];if(c)switch(c.length){case 256:d=c[b];break;case 128:d=128>b?codePageData.ASCII[b]:c[b-128];break;case 96:d=160>b?codePageData.ASCII[b]:c[b-160];break;default:d=codePageData.CP437[b]}return d},
