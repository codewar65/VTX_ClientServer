...
6==c[0]&&sendData(CSI+(crsrRow+1)+";"+(crsrCol+1)+"R");break;case 114:"*"==interm?(c=fixParams(c,[0,0]),2>c[0]&&(conBaud=100*bauds[c[1]])):""==interm&&(0==c.length?(regionTopRow=0,regionBottomRow=crtRows-1):(c=fixParams(c,[1,1]),c[0]=minMax(c[0],1,crtRows),c[1]=minMax(c[1],c[0],crtRows),regionTopRow=c[0]-1,regionBottomRow=c[1]-1));break;case 115:crsrSaveRow=crsrRow;crsrSaveCol=crsrCol;break;case 117:crsrRow=crsrSaveRow,crsrCol=crsrSaveCol,d=!0}}}d&&crsrDraw()},resetTerminal=function(){var a;modeBlinkBright=
modeVTXANSI=!1;modeCursor=!0;modeNoBlink=modeBlinkFont=modeNoBold=modeBoldFont=!1;conBaud=0;modeDOORWAY=!1;cellAttr=defCellAttr;pageAttr=defPageAttr;crsrAttr=defCrsrAttr;pageDiv.parentNode.style["background-color"]=ansiColors[pageAttr>>>8&255];pageDiv.style["background-color"]=ansiColors[pageAttr&255];for(a=conFontNum=0;10>a;a++)conFont[a]=fontName,conFontCP[a]=codePage;for(a=10;13>a;a++)conFont[a]=fontName,conFontCP[a]="TELETEXT"},scrollDown=function(){var a;if(modeRegionOrigin){var b=regionTopRow;
var d=regionBottomRow}else b=0,d=conRowAttr.length-1;expandToRow(crtRows);for(a=d;a>b;a--)conText[a]=conText[a-1],conCellAttr[a]=conCellAttr[a-1],conRowAttr[a]=conRowAttr[a-1],redrawRow(a);conText[b]="";conCellAttr[b]=[];conRowAttr[b]=defRowAttr;redrawRow(b);clearHotSpotsRow(d,0,999);moveHotSpotsRows(b,d-1,1)},scrollUp=function(){var a;if(modeRegionOrigin){var b=regionTopRow;var d=regionBottomRow}else b=0,d=conRowAttr.length-1;expandToRow(crtRows);for(a=b;a<d;a++)conText[a]=conText[a+1],conCellAttr[a]=
conCellAttr[a+1],conRowAttr[a]=conRowAttr[a+1],redrawRow(a);conText[d]="";conCellAttr[d]=[];conRowAttr[d]=defRowAttr;redrawRow(d);clearHotSpotsRow(b,0,999);moveHotSpotsRows(b+1,d,-1)},moveHotSpotsRows=function(a,b,d){var c;for(c=conHotSpots.length-1;0<=c;c--){var e=conHotSpots[c];between(e.row,a,b)&&(e.row+=d)}},moveHotSpotsRow=function(a,b,d,c){var e;for(e=conHotSpots.length-1;0<=e;e--){var f=conHotSpots[e];f.row==a&&between(f.col,b,d)&&(f.col+=c)}},clearHotSpotsRows=function(a,b){var d;for(d=conHotSpots.length-
1;0<=d;d--){var c=conHotSpots[d];between(c.row,a,b)&&conHotSpots.splice(d,1)}},clearHotSpotsRow=function(a,b,d){var c;for(c=conHotSpots.length-1;0<=c;c--){var e=conHotSpots[c];e.row==a&&e.col>=b&&e.col<=d&&conHotSpots.splice(c,1)}},conPrintChar=function(a){crsrSkipTime=(new Date).getTime();conPutChar(crsrRow,crsrCol,a,cellAttr);crsrCol++;modeAutoWrap?crsrCol==colsOnRow(crsrRow)&&(crsrCol=0,crsrRow++):crsrCol>=crtCols&&crsrCol--;lastChar=a},conPutChar=function(a,b,d,c){expandToRow(a);expandToCol(a,
b);127==d&&nop();conText[a]=conText[a].splice(b,1,String.fromCharCode(d));conCellAttr[a][b]=c;renderCell(a,b)},sendData=function(a){var b;if("string"===typeof a){var d=a;var c=d.length;a=new Uint8Array(c);for(b=0;b<c;b++)a[b]=d.charCodeAt(b)}else"number"===typeof a&&(d=String.fromCharCode(a),a=new Uint8Array([a]));if(!(a instanceof Uint8Array))throw"Invalid data in sendData().";if(vtxdata.telnet&&0<=a.indexOf(255)){var e=[];for(b=0;0<=(c=a.indexOf(255));)e.push(a.slice(0,c)),b+=c,e.push(new Uint8Array([255,
255])),b+=2,a=a.slice(c+1);b+=a.length;e.push(a);a=new Uint8Array(b);for(b=c=0;b<e.length;b++)a.set(e[b],c),c+=e[b].length}ws&&1==ws.readyState&&termState!=TS_OFFLINE?ws.send(a.buffer):(conBufferOut(d),crsrDraw())},getUnicode=function(a,b){if("UTF8"==a)return b;var d=0,c=codePageData[a]||codePageData[codePageAKAs[a]];if(c)switch(c.length){case 256:d=c[b];break;case 128:d=128>b?codePageData.ASCII[b]:c[b-128];break;case 96:d=160>b?codePageData.ASCII[b]:c[b-160];break;default:d=codePageData.CP437[b]}return d},
nop=function(){},dump=function(a,b,d){var c,e=0;var f=itoh(b,4)+":";var h="";for(c=b;c<b+d;c++)f+=" "+itoh(a[c],2),h=between(a[c],32,126)?h+String.fromCharCode(a[c]):h+".",e=e+1&15,e||(f+=": "+h+"\r\n"+itoh(c+1,4)+":",h="");for(c=e;16>c;c++)f+="   ";console.log(f+(": "+h))},ymSendStart=function(){if(!ovl.length){fadeScreen(!0);ovl.title.innerHTML="YModem Upload";ovl.filename.innerHTML="";ovl.filesize.innerHTML="";ovl.transferred.innerHTML="";var a=domElement("input",{type:"file",onchange:ymFileLoad},
{position:"relative",left:"1px",top:"1px",width:"1px",height:"1px"});ovl.dialog.appendChild(a);a.click();ovl.dialog.removeChild(a)}},cleanFileName=function(a){var b,d="";var c=0;for(b=a.length;c<b;c++){var e=a.charAt(c);var f=a.charCodeAt(c);between(f,32,126)&&-1=='/\\?%*:|"<> '.indexOf(e)&&(d+=e)}d.length||(d="untitled");return d},ymFileLoad=function(a){var b=new FileReader;var d=a.target.files[0];name=d.name;a=name.lastIndexOf("/");-1==a&&(a=name.lastIndexOf("\\"));ymFileName=cleanFileName(name.substring(a+
1));ymModifiedDate=Math.floor(d.lastModified/1E3).toString(8);ovl.filename.innerHTML=ymFileName;b.onload=ymFileLoaded;b.readAsArrayBuffer(d)},ymFileLoaded=function(a){ymFileData=new Uint8Array(a.target.result);ymFileSize=ymFileData.byteLength;ovl.filesize.innerHTML=formatSize(ymFileSize);ovl.transferred.innerHTML=formatSize(0);termState=TS_YMS_START;ymFilePos=ymNextBlock=0;ymSendStartTime=(new Date).getTime()},ymSStateMachine=function(a){var b,d;for(d=0;d<a.length;d++){clearInterval(ymTimer);var c=
a[d];switch(termState){case TS_YMS_START:if(c==_C){var e=128;ymPacketBuff=new Uint8Array(5+e);ymPacketBuff.fill(_NUL);ymPacketBuff[0]=128==e?_SOH:_STX;ymPacketBuff[1]=ymNextBlock;ymPacketBuff[2]=255-ymNextBlock;c=ymFileName+NUL+ymFileSize.toString()+" "+ymModifiedDate+" 0 0";for(b=0;b<c.length;b++)ymPacketBuff[3+b]=c.charCodeAt(b);b=calcCRC16(ymPacketBuff,3,e);ymPacketBuff[3+e]=highByte(b);ymPacketBuff[4+e]=lowByte(b);console.log("Header Packet");dump(ymPacketBuff,0,ymPacketBuff.length);sendData(ymPacketBuff);
termState=TS_YMS_PUTPACKET;ymEOTCount=ymNakCount=ymFilePos=0;ymNextBlock=ymNextBlock+1&255}else(new Date).getTime()>ymSendStartTime+1E4&&ymCancel();break;case TS_YMS_PUTWAIT:if(c==_C){ymNakCount=0;e=1024;ymPacketBuff=new Uint8Array(5+e);ymPacketBuff.fill(_CPMEOF);ymPacketBuff[0]=128==e?_SOH:_STX;ymPacketBuff[1]=ymNextBlock;ymPacketBuff[2]=255-ymNextBlock;var f=ymFilePos;for(b=0;b<e;b++,f++)if(f<ymFileSize)ymPacketBuff[3+b]=ymFileData[f];else break;b=calcCRC16(ymPacketBuff,3,e);ymPacketBuff[3+e]=highByte(b);
ymPacketBuff[4+e]=lowByte(b);sendData(ymPacketBuff);ymFilePos+=e;ymFilePos>ymFileSize&&(ymFilePos=ymFileSize);termState=TS_YMS_PUTPACKET;ymNextBlock=ymNextBlock+1&255}else break;case TS_YMS_PUTPACKET:if(c==_NAK)sendData(ymPacketBuff),ymNakCount++,10<ymNakCount&&ymCancel();else if(c==_ACK)if(ymNakCount=0,0==ymFilePos&&1==ymNextBlock)ovl.transferred.innerHTML="Sent header.",termState=TS_YMS_PUTWAIT;else if(ymFilePos==ymFileSize)ovl.transferred.innerHTML=formatSize(ymFileSize),ymEOTCount&&(termState=
TS_NORMAL,ymCancel()),ymEOTCount++,ymPacketBuff=new Uint8Array(1),ymPacketBuff[0]=_EOT,sendData(ymPacketBuff);else{ovl.transferred.innerHTML=formatSize(ymFilePos);e=1024;ymPacketBuff=new Uint8Array(5+e);ymPacketBuff.fill(_CPMEOF);ymPacketBuff[0]=128==e?_SOH:_STX;ymPacketBuff[1]=ymNextBlock;ymPacketBuff[2]=255-ymNextBlock;f=ymFilePos;for(b=0;b<e;b++,f++)if(f<ymFileSize)ymPacketBuff[3+b]=ymFileData[f];else break;b=calcCRC16(ymPacketBuff,3,e);ymPacketBuff[3+e]=highByte(b);ymPacketBuff[4+e]=lowByte(b);
sendData(ymPacketBuff);ymFilePos+=e;ymFilePos>ymFileSize&&(ymFilePos=ymFileSize);ymNextBlock=ymNextBlock+1&255}else c==_CAN&&ymCancel()}if(termState==TS_NORMAL)break}return[]},lowByte=function(a){return a&255},highByte=function(a){return a>>>8&255},twosCompliment=function(a){return 255-a&255},ymTimeOut=function(){sendData(ymPacketBuff);ymNakCount++},ymRecvStart=function(){ovl.length||(termState=TS_YMR_START,fadeScreen(!0),ovl.title.innerHTML="YModem Download",ovl.filename.innerHTML="Waiting for Remote...",
ovl.filesize.innerHTML="",ovl.transferred.innerHTML="",ymCCount=ymNextBlock=0,ymSendC(),termState!=TS_NORMAL&&(ymTimer=setInterval(ymSendC,3E3)))},ymSendC=function(){sendData(_C);ymCCount++;8<ymCCount&&(termState=TS_NORMAL,clearInterval(ymTimer),fadeScreen(!1))},ymCancel=function(){clearInterval(ymTimer);sendData(_CAN);sendData(_CAN);sendData(_CAN);sendData(_CAN);sendData(_CAN);sendData(_CAN);sendData(_CAN);sendData(_CAN);termState=TS_NORMAL;fadeScreen(!1)},formatSize=function(a){var b;for(b=0;1E3<=
a;a/=1E3,b++);return a.toFixed(2)+" "+["B","KB","MB","GB"][b]},ymRStateMachine=function(a){var b,d=[];if(!a)return d;for(b=0;b<a.length;b++){var c=a[b];switch(termState){case TS_YMR_START:ymPacketPos=0;switch(c){case _SOH:clearInterval(ymTimer);ymEOTCount=0;termState=TS_YMR_GETPACKET;ymPacketSize=132;break;case _STX:clearInterval(ymTimer);ymEOTCount=0;termState=TS_YMR_GETPACKET;ymPacketSize=1028;break;case _EOT:clearInterval(ymTimer);ymEOTCount++;if(1==ymEOTCount){sendData(_ACK);termState=TS_NORMAL;
fadeScreen(!1);if(-1<ymFileSize)ymFileData=ymFileData.slice(0,ymFileSize);else throw"EOT look for CMPEOF";saveAs(ymFileData,ymFileName);d=a.slice(b+1);ymCancel();break}sendData(_ACK);break;case _CAN:clearInterval(ymTimer),ymEOTCount=0,termState=TS_NORMAL,fadeScreen(!1),ymFileData=new Blob([],{type:"application/octet-stream"}),d=a.slice(b+1)}break;case TS_YMR_GETPACKET:if(ymPacketBuff[ymPacketPos++]=c,ymPacketPos==ymPacketSize){c=ymPacketBuff[0];var e=ymPacketBuff[1];if(c!=ymNextBlock)c==ymNextBlock-
1?sendData(_ACK):sendData(_NAK),termState=TS_YMR_START;else if(c!=(~e&255))sendData(_NAK),termState=TS_YMR_START;else{e=ymPacketBuff[ymPacketPos-2]<<8|ymPacketBuff[ymPacketPos-1];var f=calcCRC16(ymPacketBuff,2,ymPacketSize-4);if(e!=f)sendData(_NAK),termState=TS_YMR_START;else{if(0==c&&0==ymFileData.size){ymFileName="";for(e=2;ymPacketBuff[e];)ymFileName+=String.fromCharCode(ymPacketBuff[e++]);ovl.filename.innerHTML=ymFileName;e++;if(ymPacketBuff[e]){for(f="";ymPacketBuff[e]!=_SPACE&&ymPacketBuff[e]!=
_NUL;)f+=String.fromCharCode(ymPacketBuff[e++]);ymFileSize=int(f);ovl.filesize.innerHTML=formatSize(ymFileSize)}else ymFileSize=-1,ovl.filesize.innerHTML="Unknown";ymFileData=new Blob([],{type:"application/octet-stream"});ovl.transferred.innerHTML="0 bytes";sendData(_ACK);sendData(_C)}else{f=new Uint8Array(ymPacketSize-4);for(e=0;e<ymPacketSize-4;e++)f[e]=ymPacketBuff[2+e];ymPacketBuff=[];ymFileData=e=new Blob([ymFileData,f]);ovl.transferred.innerHTML=formatSize(ymFileData.size);sendData(_ACK)}termState=
TS_YMR_START;ymNextBlock=c+1&255}}}}if(termState==TS_NORMAL)break}return d},saveAs=function(a,b){var d=window.URL.createObjectURL(a);var c=domElement("a",{href:d,download:b},{display:"none"});document.body.appendChild(c);c.click();document.body.removeChild(c);setTimeout(function(){window.URL.revokeObjectURL(d)},1E3)},combineArrays=function(a,b){var d=a.length,c=new Uint8Array(d+b.length);c.set(a);c.set(b,d);return c},calcCRC16=function(a,b,d){var c=0;var e=b;for(b+=d;e<b;e++)c=updateCRC16(c,a[e]);
c=updateCRC16(c,0);c=updateCRC16(c,0);return c&65535},updateCRC16=function(a,b){var d=a,c=b|256;do d<<=1,c<<=1,c&256&&d++,d&65536&&(d^=CRC_POLY);while(!(c&65536));return d&65535},fadeScreen=function(a){a?(pageDiv.classList.add("fade"),ovl.dialog=domElement("div",{className:"noselect"},{width:"256px",height:"128px",display:"block",background:"#CCC",color:"#000",border:"2px outset #888",position:"fixed",top:(window.innerHeight-128)/2+"px",left:(pageWidth-256)/2+"px",cursor:"default",fontFamily:"san-serif",
fontSize:"12px"}),document.body.appendChild(ovl.dialog),ovl.dialog.appendChild(domElement("input",{type:"button",onclick:ymCancel,value:"Cancel"},{width:"96px",height:"24px",position:"absolute",bottom:"8px",right:"8px"})),ovl.title=domElement("span",{className:"noselect"},{width:"228px",height:"20px",background:"#039",border:"1px inset #888",position:"absolute",top:"4px",left:"4px",padding:"0px 8px",fontSize:"14px",fontWieght:"bold",color:"white"},"YModem Download"),ovl.dialog.appendChild(ovl.title),
ovl.dialog.appendChild(domElement("span",{className:"noselect"},{position:"absolute",top:"32px",left:"12px"},"File:")),ovl.filename=domElement("span",{},{position:"absolute",top:"32px",left:"80px",width:"172px",overflow:"hidden",textOverflow:"ellipsis"},"{filename}"),ovl.dialog.appendChild(ovl.filename),ovl.dialog.appendChild(domElement("span",{className:"noselect"},{position:"absolute",top:"52px",left:"12px"},"Size:")),ovl.filesize=domElement("span",{},{position:"absolute",top:"52px",left:"80px",
width:"172px",overflow:"hidden",textOverflow:"ellipsis"},"{filesize}"),ovl.dialog.appendChild(ovl.filesize),ovl.dialog.appendChild(domElement("span",{className:"noselect"},{position:"absolute",top:"72px",left:"12px"},"Transferred:")),ovl.transferred=domElement("span",{},{position:"absolute",top:"72px",left:"80px",width:"172px",overflow:"hidden",textOverflow:"ellipsis"},"{transferred}"),ovl.dialog.appendChild(ovl.transferred),setBulbs(),document.getElementById("ulbtn").style.visibility="hidden",document.getElementById("dlbtn").style.visibility=
"hidden",setTimers(!1),document.body.style.cursor="wait"):(pageDiv.classList.remove("fade"),ovl.dialog&&document.body.removeChild(ovl.dialog),ovl={},document.getElementById("ulbtn").style.visibility="visible",document.getElementById("dlbtn").style.visibility="visible",setTimers(!0),document.body.style.cursor="default")},UFT16ArrayToStr=function(a){var b,d;var c="";var e=d=a.length;for(b=0;b<d;){if(b>=d-1){e=b-1;break}var f=a[b++];var h=a[b++];c+=string.fromCharCode(f<<8|h)}return{strData:c,leftOver:a.slice(e)}},
UFT8ArrayToStr=function(a){var b,d;var c="";var e=d=a.length;for(b=0;b<d;){var f=a[b++];switch(f>>>4){case 0:case 1:case 2:case 3:case 4:case 5:case 6:case 7:c+=String.fromCharCode(f);break;case 12:case 13:if(b>=d-1){e=b-1;b=d;break}var h=a[b++];c+=String.fromCharCode((f&31)<<6|h&63);break;case 14:if(b>=d-2)e=b-1,b=d;else{h=a[b++];var k=a[b++];c+=String.fromCharCode((f&15)<<12|(h&63)<<6|(k&63)<<0)}}}return{strData:c,leftOver:a.slice(e)}},initDisplay=function(){var a;hotspotHoverAttr=524543;hotspotClickAttr=
255;if(a=document.getElementById("vtxclient")){pageDiv=domElement("div",{id:"vtxpage",className:"noselect"});textDiv=domElement("div",{id:"vtxtext",className:"noselect"});pageDiv.appendChild(textDiv);a.appendChild(pageDiv);textPos=getElementPosition(textDiv);getDefaultFontSize();crtWidth=colSize*crtCols;codePageData[codePage]||codePageAKAs[codePage]&&(codePage=codePageAKAs[codePage]);if(cbm){conFontNum=0;switch(vtxdata.codePage){case "VIC20":conFont[0]="VIC200";conFont[1]="VIC201";cbmColors=vic20Colors;
...
a=document.createElement("style");a.type="text/css";var b="#vtxpage { font-family: "+fontName+"; font-size: "+fontSize+"px; min-height: "+(fontSize*vtxdata.crtRows).toString()+"px; margin: 0px auto; padding: 0px; border: 0px; overflow: hidden; text-overflow: clip; z-index: 0; position: relative;}\n#vtxtext { width: 100%; margin: 0px; padding: 0px; border: 0px; overflow: hidden; text-overflow: clip; z-index: 10; position: relative;}\n.vtx { position: relative; left: 0px; line-height: "+fontSize+"px; height: "+
fontSize+"px; vertical-align: top; overflow: hidden; text-overflow: clip;}\n.fade { opacity: .5; background: #000055;}\n.noselect { -webkit-touch-callout: none; -webkit-user-select: none; -khtml-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none;}\n.marquee { animation: marquee 12s linear infinite; } @keyframes marquee { 0% { transform: translate( "+xScale*crtCols*colSize+"px, 0); } 100% { transform: translate(-100%, 0); }}";a.styleSheet?a.styleSheet.cssText=b:a.appendChild(document.createTextNode(b));
(document.head||document.getElementsByTagName("head")[0]).appendChild(a);defCellAttr=vtxdata.defCellAttr;defCrsrAttr=vtxdata.defCrsrAttr;defPageAttr=vtxdata.defPageAttr;cellAttr=defCellAttr;crsrAttr=defCrsrAttr;pageAttr=defPageAttr;newCrsr();crsrSkipTime=0;soundBell=new Audio;soundBell.src=vtxPath+"bell.mp3";soundBell.type="audio/mp3";soundBell.volume=1;soundBell.preload="auto";soundBell.load();a=pageDiv.parentNode;cbm?(a.style["background-color"]=cbmColors[pageAttr>>>8&15],pageDiv.style["background-color"]=
...
{id:"ctrls"},{width:"24px",height:"164px",position:"absolute",top:textPos.top+"px",left:6+textPos.left+crtWidth*xScale+"px"});ctrlDiv.appendChild(domElement("img",{src:vtxPath+"os0.png",id:"osbulb",onclick:termConnect,width:24,height:24,title:"Connect/Disconnect"},{cursor:"pointer"}));ctrlDiv.appendChild(domElement("img",{src:vtxPath+"cl0.png",id:"clbulb",width:24,height:24,title:"CapsLk"}));ctrlDiv.appendChild(domElement("img",{src:vtxPath+"nl0.png",id:"nlbulb",width:24,height:24,title:"NumLk"}));
ctrlDiv.appendChild(domElement("img",{src:vtxPath+"sl0.png",id:"slbulb",width:24,height:24,title:"ScrLk"}));ctrlDiv.appendChild(domElement("img",{src:vtxPath+"ul0.png",id:"ulbtn",onclick:ymSendStart,width:24,height:24,title:"YModem Upload"},{cursor:"pointer"}));ctrlDiv.appendChild(domElement("img",{src:vtxPath+"dl0.png",id:"dlbtn",onclick:ymRecvStart,width:24,height:24,title:"YModem Download"},{cursor:"pointer"}));pageDiv.parentNode.appendChild(ctrlDiv);audioEl=domElement("audio",{id:"vtxaudio",preload:"none",
volume:"0.25",src:"/;"},{width:"0px",height:"0px"});pageDiv.appendChild(audioEl);conBufferOut(initStr);if(vtxdata.autoConnect&&0<vtxdata.autoConnect)termConnect();else switch(vtxdata.term){case "PETSCII":conStrOut("\u000evtx tERMINAL cLIENT\r");conStrOut("vERSION "+version+"\r");conStrOut("2017 dAN mECKLENBURG jR.\r");conStrOut("GITHUB.COM/CODEWAR65/vtx\u00a4cLIENTsERVER\r");conStrOut("\rcLICK cONNECT...\r");break;case "ATASCII":conStrOut("VTX Terminal Client\u009b");conStrOut("Version "+version+
...
31,TN_TSPEED=32,TN_RFC=33,TN_LM=34,TN_XLOC=35,TN_EVARS=36,TN_AUTH=37,TN_NEWE=39,TN_SE=240,TN_NOP=241,TN_DM=242,TN_BRK=243,TN_IP=244,TN_AO=245,TN_AYT=246,TN_EC=247,TN_EL=248,TN_GA=249,TN_SB=250,TN_WILL=251,TN_WONT=252,TN_DO=253,TN_DONT=254,TN_IAC=255,TNQ_NO=0,TNQ_YES=1,TNQ_WANTNO=2,TNQ_WANTYES=3,TNQ_WANTNO_OP=4,TNQ_WANTYES_OP=5,CRC_POLY=4129,vtxPath="",codePage=vtxdata.codePage,wsConnect=vtxdata.wsConnect,crtCols=vtxdata.crtCols,crtRows=vtxdata.crtRows,xScale=vtxdata.xScale,term=vtxdata.term,cbm="PETSCII"==
vtxdata.term,atari="ATASCII"==vtxdata.term,initStr=vtxdata.initStr,cbmColors,ws=null,irqWriteBuffer=null,irqCheckResize=null,irqCursor=null,irqBlink=null,fontName,fontSize,vtxFontsLoaded,rowSize,colSize,crtWidth,pageWidth,pagePos,pageLeft,pageTop,elPage=document.getElementsByTagName("html")[0],crsr,crsrRow,crsrCol,crsrSaveRow=0,crsrSaveCol=0,cellSaveAttr=0,pageAttr,crsrAttr,crsrBlink,crsrSkipTime,cellAttr,cellBlinkSlow,cellBlinkFast,defPageAttr,defCrsrAttr,defCellAttr,defRowAttr=2883584,lastChar,
lastHotSpot=null,hotspotHoverAttr,hotspotClickAttr,conBaud=0,audioEl,termState,pageDiv=null,ctrlDiv=null,textDiv=null,soundBell=null,textPos=null,parms="",interm="",ansiState=0,modeVTXANSI=!1,modeBlinkBright=!1,modeCursor=!0,modeBoldFont=!1,modeNoBold=!1,modeBlinkFont=!1,modeNoBlink=!1,modeCBMShift=!0,modeDOORWAY=!1,modeAutoWrap=!0,modeSaveAutoWrap,modeNextGlyph=!1,modeRegionOrigin,modeTeletext=!1,regionTopRow,regionBottomRow,conBuffer="",conRowAttr=[],conCellAttr=[],conText=[],conHotSpots=[],spriteDefs=
[],audioDefs=[],conTabStop=[],conFont=[],conFontCP=[],conFontNum=0,ovl={},shiftState,ctrlState,altState,numState,capState,scrState,tnState,tnCmd,tnQUs=new Uint8Array(256),tnQHim=new Uint8Array(256),ymTimer,ymCCount,ymPacketSize,ymPacketPos,ymPacketBuff=[],ymFileName,ymFileSize,ymModifiedDate,ymFilePos,ymFileData=new Blob([],{type:"application/octet-stream"}),ymEOTCount,ymNakCount,ymNextBlock,ymSendStartTime;
String.prototype.splice||(String.prototype.splice=function(a,b,d){0>a&&(a=this.length+a,0>a&&(a=0));return this.slice(0,a)+(d||"")+this.slice(a+b)});var inBuff=new Uint8Array(0),ttxGraphics,ttxSeparated,ttxDouble,ttxBottom,ttxHeld;addListener(window,"load",bootVTX);