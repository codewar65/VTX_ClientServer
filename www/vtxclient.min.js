...
"ATARI",conFontCP[0]="RAW";else{for(a=conFontNum=0;10>a;a++)conFont[a]=fontName,conFontCP[a]=codePage;for(a=10;13>a;a++)conFont[a]=fontName,conFontCP[a]="TELETEXT"}pageDiv.style.width=crtWidth*xScale+"px";pagePos=getElementPosition(pageDiv);pageLeft=pagePos.left;pageTop=pagePos.top;a=document.createElement("style");a.type="text/css";var b="#vtxpage { font-family: "+fontName+"; font-size: "+fontSize+"px; min-height: "+(fontSize*vtxdata.crtRows).toString()+"px; margin: 0px auto; padding: 0px; border: 0px; overflow: hidden; text-overflow: clip; z-index: 0; position: relative;}\n#vtxtext { width: 100%; margin: 0px; padding: 0px; border: 0px; overflow: hidden; text-overflow: clip; z-index: 10; position: relative;}\n.vtx { position: relative; left: 0px; line-height: 1em; height: 1em; vertical-align: top; overflow: hidden; text-overflow: clip;}\n.fade { opacity: .5; background: #000055;}.noselect { -webkit-touch-callout: none; -webkit-user-select: none; -khtml-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none;}";
b+=".marquee { animation: marquee 12s linear infinite; } @keyframes marquee { 0% { transform: translate( "+xScale*crtCols*colSize+"px, 0); } 100% { transform: translate(-100%, 0); }}";a.styleSheet?a.styleSheet.cssText=b:a.appendChild(document.createTextNode(b));(document.head||document.getElementsByTagName("head")[0]).appendChild(a);defCellAttr=vtxdata.defCellAttr;defCrsrAttr=vtxdata.defCrsrAttr;defPageAttr=vtxdata.defPageAttr;cellAttr=defCellAttr;crsrAttr=defCrsrAttr;pageAttr=defPageAttr;newCrsr();
crsrSkipTime=0;soundBell=new Audio;soundBell.src=vtxPath+"bell.mp3";soundBell.type="audio/mp3";soundBell.volume=1;soundBell.preload="auto";soundBell.load();a=pageDiv.parentNode;cbm?(a.style["background-color"]=cbmColors[pageAttr>>>8&15],pageDiv.style["background-color"]=cbmColors[pageAttr&15]):atari?(a.style["background-color"]=atariColors[pageAttr>>>8&1],pageDiv.style["background-color"]=atariColors[pageAttr&1]):(a.style["background-color"]=ansiColors[pageAttr>>>8&255],pageDiv.style["background-color"]=
ansiColors[pageAttr&255]);pageWidth=elPage.clientWidth;crsrBlink=shiftState=ctrlState=altState=capState=numState=scrState=!1;cellBlinkFast=cellBlinkSlow=!0;crsrRow=crsrCol=0;crsrDraw();elPage=document.getElementsByTagName("html")[0];setTimers(!0);crsrRow=crsrCol=0;textPos=textDiv.getBoundingClientRect();termState=TS_OFFLINE;ctrlDiv=domElement("div",{id:"ctrls"},{width:"24px",height:"164px",position:"absolute",top:textPos.top+"px",left:6+textPos.left+crtWidth*xScale+"px"});ctrlDiv.appendChild(domElement("img",
{src:vtxPath+"os0.png",id:"osbulb",onclick:termConnect,width:24,height:24,title:"Connect/Disconnect"},{cursor:"pointer"}));ctrlDiv.appendChild(domElement("img",{src:vtxPath+"cl0.png",id:"clbulb",width:24,height:24,title:"CapsLk"}));ctrlDiv.appendChild(domElement("img",{src:vtxPath+"nl0.png",id:"nlbulb",width:24,height:24,title:"NumLk"}));ctrlDiv.appendChild(domElement("img",{src:vtxPath+"sl0.png",id:"slbulb",width:24,height:24,title:"ScrLk"}));ctrlDiv.appendChild(domElement("img",{src:vtxPath+"ul0.png",
id:"ulbtn",onclick:ymSendStart,width:24,height:24,title:"YModem Upload"},{cursor:"pointer"}));ctrlDiv.appendChild(domElement("img",{src:vtxPath+"dl0.png",id:"dlbtn",onclick:ymRecvStart,width:24,height:24,title:"YModem Download"},{cursor:"pointer"}));pageDiv.parentNode.appendChild(ctrlDiv);audio=domElement("audio",{id:"vtxaudio",preload:"none",volume:"0.25",src:"/;"},{width:"0px",height:"0px"});pageDiv.appendChild(audio);conBufferOut(initStr);if(vtxdata.autoConnect&&0<vtxdata.autoConnect)termConnect();
else switch(vtxdata.term){case "PETSCII":conStrOut("\u000evtx tERMINAL cLIENT\r");conStrOut("vERSION 0.9\r");conStrOut("2017 dAN mECKLENBURG jR.\r");conStrOut("GITHUB.COM/CODEWAR65/vtx\u00a4cLIENTsERVER\r");conStrOut("\rcLICK cONNECT...\r");break;case "ATASCII":conStrOut("VTX Terminal Client\u009b");conStrOut("Version 0.9\u009b");conStrOut("2017 Dan Mecklenburg Jr.\u009b");conStrOut("github.com/codewar65/VTX_ClientServer\u009b");conStrOut("\u009bClick Connect...\u009b");break;default:conStrOut("\n\r\u001b#6\u001b[38;5;46;58mVTX\u001b[32;78m Terminal Client\n\r"),
...
new Uint8Array(a.data);1==vtxdata.telnet&&(b=tnNegotiate(b));switch(termState){case TS_NORMAL:switch(codePage){case "UTF8":var d=UFT8ArrayToStr(b);break;case "UTF16":d=b.toString();break;default:for(d="",a=0;a<b.length;a++)d+=String.fromCharCode(b[a])}conBufferOut(d);break;case TS_YMR_START:case TS_YMR_GETPACKET:b=ymRStateMachine(b);0<b.length&&conBufferOut(d);break;case TS_YMS_START:case TS_YMS_PUTPACKET:case TS_YMS_PUTWAIT:b=ymSStateMachine(b),0<b.length&&conBufferOut(d)}},ws.onopen=function(){vtxdata.telnet&&
tnInit();termState=TS_NORMAL;setBulbs()},ws.onclose=function(){conBaud=0;cbm?conBufferOut("\r\rDISCONNECTED.\r"):atari?conBufferOut("\u009b\u009bDisconnected.\u009b"):conBufferOut("\r\n\r\n\u001b[#9\u001b[0;91mDisconnected.\r\n");document.body.style.cursor="default";audio&&(audio.pause(),pageDiv.removeChild(audio));termState=TS_OFFLINE;setBulbs()},ws.onerror=function(a){cbm?conBufferOut("\r\rERROR : "+a.reason.toUpper()+"\r"):atari?conBufferOut("\u009b\u009bError : "+a.reason()+"\tB"):conBufferOut("\r\n\r\n\u001b[#9\u001b[0;91mError : "+
a.reason+"\r\n");setBulbs()}):ws.close()},newCrsr=function(){var a=["0%","10%","25%","100%"];if(null==crsr){crsr=domElement("div",{},{position:"absolute",display:"block",zIndex:"999"});var b=domElement("div",{id:"crsr"},{position:"absolute",display:"block",bottom:"0px",left:"0px"});crsr.appendChild(b);textDiv.appendChild(crsr)}else b=crsr.firstChild;var d=getCrsrAttrOrientation(crsrAttr);var c=getCrsrAttrSize(crsrAttr);switch(d){case 0:b.style.width="100%";b.style.height=a[c];break;default:b.style.height=
"100%",b.style.width=a[c]}a=getCrsrAttrColor(crsrAttr);b.style["background-color"]=cbm?cbmColors[a&15]:atari?atariColors[a&1]:ansiColors[a]},paste=function(a){a=a||window.event;a.stopPropagation();a.preventDefault();conBufferOut((a.clipboardData||window.clipboardData).getData("Text"))},beforePaste=function(a){a.returnValue=!1},setTimers=function(a){a?(null==irqWriteBuffer&&(irqWriteBuffer=setInterval(doWriteBuffer,33)),null==irqCheckResize&&(irqCheckResize=setInterval(doCheckResize,10)),null==irqCursor&&
(irqCursor=setInterval(doCursor,533)),null==irqBlink&&(irqBlink=setInterval(doBlink,533))):(null!=irqWriteBuffer&&clearInterval(irqWriteBuffer),null!=irqCheckResize&&clearInterval(irqCheckResize),null!=irqCursor&&clearInterval(irqCursor),null!=irqBlink&&clearInterval(irqBlink),irqBlink=irqCursor=irqCheckResize=irqWriteBuffer=null)},setBulbs=function(){var a=document.getElementById("osbulb");termState==TS_OFFLINE?(a.src=vtxPath+"os0.png",a.title="Connect"):(a.src=vtxPath+"os1.png",a.title="Disconnect");
document.getElementById("clbulb").src=vtxPath+(capState?"cl1":"cl0")+".png";document.getElementById("nlbulb").src=vtxPath+(numState?"nl1":"nl0")+".png";document.getElementById("slbulb").src=vtxPath+(scrState?"sl1":"sl0")+".png";termState==TS_NORMAL?(a=document.getElementById("ulbtn"),a.src=vtxPath+"ul1.png",a.style.visibility="visible",a=document.getElementById("dlbtn"),a.src=vtxPath+"dl1.png",a.style.visibility="visible"):termState==TS_OFFLINE?(a=document.getElementById("ulbtn"),a.src=vtxPath+"ul0.png",
a.style.visibility="visible",a=document.getElementById("dlbtn"),a.src=vtxPath+"dl0.png",a.style.visibility="visible"):(document.getElementById("ulbtn").style.visibility="hidden",document.getElementById("dlbtn").style.visibility="hidden")},fitSVGToDiv=function(a){var b=this.parentNode.getBoundingClientRect();a=b.width;b=b.height;var d=this.naturalWidth;var c=this.naturalHeight;this.style["transform-origin"]="top left";this.style.transform="scale("+a/c+","+b/d+")";this.style.visibility="visible"},expandToRow=
function(a){if(a>=conRowAttr.length){for(;a>getMaxRow();)textDiv.appendChild(createNewRow()),conRowAttr[conRowAttr.length]=2883584,conCellAttr[conCellAttr.length]=[],conText[conText.length]="";trimHistory()}},expandToCol=function(a,b){for(;conText[a].length<b;)conText[a]+=" ";for(;conCellAttr[a].length<b;)conCellAttr[a][conCellAttr[a].length]=defCellAttr},brightenRGB=function(a,b){if("transparent"==a)return a;var d=htoi(a.substring(1));var c=d>>>16&255;var e=d>>>8&255;d&=255;0>b?(b+=1,c*=b,e*=b,d*=
b):(c=(255-c)*b+c,e=(255-e)*b+e,d=(255-d)*b+d);c=Math.floor(c)&255;e=Math.floor(e)&255;d=Math.floor(d)&255;return"#"+itoh((c<<16)+(e<<8)+d,6)},drawMosaicBlock=function(a,b,d,c,e){var f,h,k=1,m=Math.floor(d/2),g=Math.floor(c/3),l,r=0;e=e?-1:0;d-=2*m;c-=3*g;b-=32;31<b&&(b-=32);for(h=0;3>h;h++){for(f=l=0;2>f;f++)b&k&&a.fillRect(l,r,m+(f?d:0)+e,g+(2==h?c:0)+e),l+=m,k<<=1;r+=g}},renderCell=function(a,b,d,c){d=(void 0===d?0:d)||0;var e=(c=(void 0===c?!1:c)||!1)?-1:0;if(!(a+e>conRowAttr.length||b>=conText[a+
e].length)){var f=getRowAttrHeight(conRowAttr[a+e])/100;var h=getRowAttrWidth(conRowAttr[a+e])/100;var k=xScale*colSize*h;var m=k*b;if(!(m>k*crtCols)||conRowAttr[a]&A_ROW_MARQUEE){var g=getRowElement(a);var l=fontSize*f;var r=.1*l;var p=g.firstChild;p||(p=domElement("canvas",{width:crtCols*k,height:l+16},{zIndex:"50"}),g.appendChild(p));g=p.getContext("2d");p=conText[a+e].charAt(b);b=conCellAttr[a+e][b];1==d?b=hotspotHoverAttr:2==d&&(b=hotspotClickAttr);d=b&255;var n=b>>>8&255;e=(b&A_CELL_FONT_MASK)>>>
28&15;var q=b&A_CELL_BOLD;modeNoBold&&(q=0);var v=b&(A_CELL_BLINKSLOW|A_CELL_BLINKFAST);modeBoldFont&&q&&(e=1);modeBlinkFont&&v&&(e=2);modeBoldFont&&q&&modeBlinkFont&&v&&(e=3);if(b&A_CELL_REVERSE){var w=d;d=n;n=w}cbm||atari||modeVTXANSI||(q&&8>d&&(d+=8),q=!1);modeBlinkBright&&8>n&&v&&(n+=8,b&=~(A_CELL_BLINKSLOW|A_CELL_BLINKFAST));cbm||atari||(0==d&&(d=16),0!=n||modeVTXANSI||(n=16));9608==p.charCodeAt(0)&&(p=" ",n=d);g.save();g.beginPath();g.rect(m,0,k,l);g.clip();cbm?(g.fillStyle=cbmColors[n],g.fillRect(m,
0,k,l)):atari?(g.fillStyle=atariColors[n],g.fillRect(m,0,k,l)):0<n?(g.fillStyle=ansiColors[n],g.fillRect(m,0,k,l)):g.clearRect(m,0,k,l);n=!0;if(b&A_CELL_BLINKSLOW&&cellBlinkSlow||b&A_CELL_BLINKFAST&&cellBlinkFast)modeNoBlink||(n=!1);switch(conRowAttr[a]&A_ROW_DISPLAY_MASK){case A_ROW_DISPLAY_NORMAL:a=b&A_CELL_DISPLAY_MASK;switch(a){case A_CELL_DISPLAY_NORMAL:var t=0;var u=1;break;case A_CELL_DISPLAY_CONCEAL:n=!1;break;case A_CELL_DISPLAY_TOP:t=0;u=2;break;case A_CELL_DISPLAY_BOTTOM:t=-l,u=2}break;
case A_ROW_DISPLAY_CONCEAL:n=!1;break;case A_ROW_DISPLAY_TOP:t=0;u=2;break;case A_ROW_DISPLAY_BOTTOM:t=-l,u=2}if(n){g.fillStyle=b&A_CELL_FAINT?brightenRGB(ansiColors[d],-.33):cbm?cbmColors[d]:atari?atariColors[d]:ansiColors[d];a=-1;if(11==e||12==e){if(" "<=p&&"?">=p||"`"<=p&&"\u007f">=p)a=e-11;g.font=(q?"bold ":"")+fontSize+"px "+conFont[e]}else g.font=cbm?(q?"bold ":"")+fontSize+"px "+conFont[conFontNum]:(q?"bold ":"")+fontSize+"px "+conFont[e];g.textAlign="start";g.textBaseline="top";b&A_CELL_SHADOW&&
(g.shadowColor="#000000",g.shadowOffsetX=l/rowSize,g.shadowOffsetY=l/rowSize);n=q=g.shadowBlur=0;b&A_CELL_ITALICS&&(q=-.125,n=1);c&&(t=-l,u=2);-1==a&&(p=String.fromCharCode(getUnicode(conFontCP[e],p.charCodeAt(0))));g.setTransform(xScale*h,0,xScale*q,u*f,m+xScale*n,t);b&A_CELL_OUTLINE?(g.strokeStyle=ansiColors[d],g.lineWidth=1,g.strokeText(p,0,0)):0<=a?drawMosaicBlock(g,p.charCodeAt(0),k/h,l,a):g.fillText(p,0,0);b&A_CELL_UNDERLINE&&g.fillRect(0,l-r,k,r);b&A_CELL_STRIKETHROUGH&&g.fillRect(0,(l+r)/
...
4,d+=hex.indexOf(a.charAt(c));return d},itoh=function(a,b){var d="";for(b=b||0;a;d=hex.charAt(a&15)+d,a>>=4);if(0<b)for(;d.length<b;)d="0"+d;return d},getRowFontSize=function(a){var b=conRowAttr[a];a=colSize*(getRowAttrWidth(b)/100);b=rowSize*(getRowAttrHeight(b)/100);return{width:a,height:b}},doBlink=function(){var a,b;if(!modeNoBlink&&!modeBlinkBright){var d=textDiv.getBoundingClientRect().top;for(a=0;a<conRowAttr.length;a++){var c=rowSize*getRowAttrHeight(conRowAttr[a])/100;if(0<d+c&&d<window.innerHeight)for(b=
0;b<conCellAttr[a].length;b++)conCellAttr[a][b]&(A_CELL_BLINKSLOW|A_CELL_BLINKFAST)&&renderCell(a,b);d+=c}}(cellBlinkFast=!cellBlinkFast)&&(cellBlinkSlow=!cellBlinkSlow)},doCursor=function(){crsr.firstChild.style["background-color"]=cbm?(crsrBlink=!crsrBlink)||!modeCursor?"transparent":cbmColors[cellAttr&15]:atari?(crsrBlink=!crsrBlink)||!modeCursor?"transparent":atariColors[cellAttr&1]:(crsrBlink=!crsrBlink)||!modeCursor?"transparent":ansiColors[getCrsrAttrColor(crsrAttr)]},doCheckResize=function(){textPos=
textDiv.getBoundingClientRect();elPage.clientWidth!=pageWidth&&(pageWidth=elPage.clientWidth,crsrDraw(!0))},getRowElement=function(a){var b=document.getElementsByClassName("vtx");return a>b.length?null:b[a]},XcrsrRight=function(){crsrCol++;crsrDraw()},XcrsrLeft=function(){0<crsrCol&&crsrCol--;crsrDraw()},XcrsrUp=function(){0<crsrRow&&crsrRow--;crsrDraw()},XcrsrMove=function(a,b){crsrRow=a;crsrCol=b;crsrDraw()},XcrsrHome=function(){crsrRow=crsrCol=0;crsrDraw()},getMaxCol=function(a){return conText[a].length-
1},getMaxRow=function(){return conRowAttr.length-1},getDefaultFontSize=function(){var a,b,d,c;var e="\u2588\u2584\u2580\u2590\u258c\u2591\u2592\u2593";for(a=32;128>a;a++)e+=String.fromCharCode(a);e+="\u2588\u2584\u2580\u2590\u258c\u2591\u2592\u2593";a=document.defaultView.getComputedStyle(pageDiv,null);fontName=vtxdata.fontName||a["font-family"];fontSize=int(vtxdata.fontSize)||int(a["font-size"]);a=fontSize+"px "+fontName;var f=domElement("canvas",{width:2E3,height:64}).getContext("2d");f.font=a;
f.textBaseline="top";f.textAlign="left";f.fillStyle="#FFF";f.fillText(e,0,0);var h=f.getImageData(0,0,2E3,64).data;var k=d=2E3;for(f=c=b=0;64>f;f++)for(a=0;2E3>a;a++){var m=h[4*(2E3*f+a)];0!=m&&(f<k&&(k=f),f>b&&(b=f),a<d&&(d=a),a>c&&(c=a))}colSize=Math.round((c-d)/e.length-.25);rowSize=Math.floor(b-k)+1},crsrDraw=function(a){expandToRow(crsrRow);a=getRowElement(crsrRow);if(null!=a){a=getElementPosition(a);var b=document.documentElement.scrollTop||document.body.scrollTop;var d="innerHeight"in window?
window.innerHeight:document.documentElement.offsetHeight;var c=getRowFontSize(crsrRow);crsr.style.top=a.top-pageTop+"px";crsr.style.left=xScale*crsrCol*c.width+"px";crsr.style.width=xScale*c.width+"px";crsr.style.height=c.height+"px";a.top<b?window.scrollTo(0,a.top-8):a.top+c.height>b+d&&window.scrollTo(0,a.top+c.height+8)}},getElementPosition=function(a){for(var b=a.offsetLeft,d=a.offsetTop;a.offsetParent;)a=a.offsetParent,b+=a.offsetLeft,d+=a.offsetTop;return{left:b,top:d}},fixParams=function(a,
b){var d;for(d=a.length;d<b.length;d++)a[d]=b[d];return a.slice(0,b.length)},colsOnRow=function(a){var b=crtCols;a=getRowAttrWidth(conRowAttr[a])/100;return 1/a*b},createNewRow=function(){var a=domElement("div",{className:"vtx"});domElement("canvas");return a},insChar=function(a,b,d){expandToRow(a);expandToCol(a,b);conText[a]=conText[a].splice(b,0,String.fromCharCode(d));conCellAttr[a].splice(b,0,defCellAttr);moveHotSpotsRow(a,b,999,1);redrawRow(a)},delChar=function(a,b){expandToRow(a);expandToCol(a,
b);conText[a]=conText[a].splice(b,1);conCellAttr[a].splice(b,1);moveHotSpotsRow(a,b,999,-1);redrawRow(a)},trimHistory=function(){for(var a,b;conRowAttr.length>vtxdata.crtHistory;)clearHotSpotsRow(0,0,999),a=document.getElementsByClassName("vtx"),b=a[0].parentNode,b.removeChild(a[0]),conRowAttr.splice(0,1),conText.splice(0,1),conCellAttr.splice(0,1),crsrRow--},insRow=function(a){var b=document.getElementsByClassName("vtx");b[a].parentNode.insertBefore(createNewRow(),b[a]);conRowAttr.splice(a,0,defRowAttr);
conText.splice(a,0,"");conCellAttr.splice(a,0,[]);moveHotSpotsRows(a,conRowAttr.length,1);trimHistory()},delRow=function(a){expandToRow(a);var b=document.getElementsByClassName("vtx");b[a-1].parentNode.removeChild(b[a]);conRowAttr.splice(a,1);conText.splice(a,1);conCellAttr.splice(a,1);clearHotSpotsRow(a,0,999);moveHotSpotsRows(a+1,conRowAttr.length,-1)},keyPress=function(a){a=a||window.event;var b=a.charCode;shiftState=a.shiftKey;ctrlState=a.ctrlKey;altState=a.altKey;capState=between(b,65,90)&&!shiftState||
between(b,97,112)&&shiftState},keyDown=function(a){a=a||window.event;var b=a.keyCode||a.which;crsr.style.display="block";shiftState=a.shiftKey;ctrlState=a.ctrlKey;altState=a.altKey;if(!(termState>TS_NORMAL)){var d=(shiftState?1:0)+(ctrlState?2:0)+(altState?4:0);between(b,65,90)&&2>d&&capState&&(d^=1);cbm&&between(b,65,90)&&(d^=1);d=keyVals[d][b];if(null==d||"function"==typeof d&&(d=d(),null==d))return a.returnValue=!0;if("string"==typeof d)return sendData(d),a.preventDefault(),a.returnValue=!1;if("number"==
...
a=a||window.event;shiftState=a.shiftKey;ctrlState=a.ctrlKey;altState=a.altKey;if(!(termState>TS_NORMAL)&&(d=getHotSpot(a))){for(b=0;b<d.height;b++)for(a=0;a<d.width;a++)renderCell(d.row+b,d.col+a,d.hilite?2:0);switch(d.type){case 0:sendData(d.val);break;case 1:a=window.open(d.val,"_blank"),a.focus()}}},mouseMove=function(a){var b,d;a=a||window.event;shiftState=a.shiftKey;ctrlState=a.ctrlKey;altState=a.altKey;if(!(termState>TS_NORMAL)){if(d=getHotSpot(a)){if(lastHotSpot!=d){if(lastHotSpot)for(b=0;b<
lastHotSpot.height;b++)for(a=0;a<lastHotSpot.width;a++)renderCell(lastHotSpot.row+b,lastHotSpot.col+a);for(b=0;b<d.height;b++)for(a=0;a<d.width;a++)renderCell(d.row+b,d.col+a,d.hilite?1:0)}document.body.style.cursor="pointer"}else{if(lastHotSpot)for(b=0;b<lastHotSpot.height;b++)for(a=0;a<lastHotSpot.width;a++)renderCell(lastHotSpot.row+b,lastHotSpot.col+a);document.body.style.cursor="default"}lastHotSpot=d}},mouseDown=function(a){a=a||window.event;shiftState=a.shiftKey;ctrlState=a.ctrlKey;altState=
a.altKey},mouseUp=function(a){a=a||window.event;shiftState=a.shiftKey;ctrlState=a.ctrlKey;altState=a.altKey},getHotSpot=function(a){var b;if(b=getMouseCell(a))for(a=0;a<conHotSpots.length;a++){var d=conHotSpots[a];if(between(b.row,d.row,d.row+d.height-1)&&between(b.col,d.col,d.col+d.width-1))return conHotSpots[a]}return null},getMouseCell=function(a){var b=a.clientX;var d=a.clientY+0;var c=textPos.top;if(d>=c&&between(b,textPos.left,textPos.left+crtWidth-1))for(a=0;a<conRowAttr.length;a++){var e=
getRowAttrHeight(conRowAttr[a])/100;var f=getRowAttrWidth(conRowAttr[a])/100;e=Math.round(fontSize*e);if(between(d,c,c+e-1))return b=(b-textPos.left)/(xScale*colSize*f),{row:a,col:Math.floor(b)};c+=e}return null},redrawFont=function(a){var b,d;a=conFont.indexOf(a);if(0<=a)for(b=conRowAttr.length-1;0<=b;b--)for(d=conCellAttr[b].length-1;0<=d;d--){var c=(conCellAttr[b][d]&A_CELL_FONT_MASK)>>>28;c==a&&renderCell(b,d,0,!1)}},loadSingleFont=function(a){var b,d=document.getElementsByTagName("head")[0];
var c=vtxFonts.indexOf(a);if(0<=c&&!vtxFontsLoaded[c]){var e='@font-face {\r\n   font-family: "'+a+'";   src: url("'+vtxPath+a+'.woff") format("woff"); }\r\n';(b=document.getElementById("vtxfonts"))?b.innerHTML+=e:b=domElement("style",{type:"text/css"},{},e);d.appendChild(b);var f=domElement("div",{},{fontFamily:a+', "AdobeBlank"',fontSize:"24px",fontWeight:"normal",color:"transparent",display:"inline-block",border:"0px",padding:"0px",margin:"0px"},"Test 1..2..3..");document.body.appendChild(f);var h=
setInterval(function(){32<f.offsetWidth&&(vtxFontsLoaded[c]=!0,document.body.removeChild(f),clearInterval(h),setTimeout(function(){redrawFont(a)},250))},250)}},bootVTX2=function(){for(var a=document.getElementsByTagName("title")[0],b=document.getElementsByTagName("head")[0];!vtxdata;);a?a.innerText&&""!=a.innerText||(a.innerText=vtxdata.sysName):b.appendChild(domElement("title",{},{},vtxdata.sysName));window.setTimeout(initDisplay,100)},bootVTX1=function(){var a,b;document.getElementsByTagName("title");
document.getElementsByTagName("head");var d=[];vtxFontsLoaded=Array(vtxFonts.length);vtxFontsLoaded.fill(!1);var c=[];switch(vtxdata.term){case "PETSCII":switch(vtxdata.codePage){case "VIC20":c.push("VIC200");c.push("VIC201");break;case "C128":c.push("C1280");c.push("C1281");break;default:c.push("C640"),c.push("C641")}break;case "ATASCII":c.push("ATARI");break;default:c.push("UVGA16")}var e=document.getElementById("vtxfonts");var f="";var h=0;for(b=c.length;h<b;h++)f+='@font-face {\r\n   font-family: "'+
c[h]+'";   src: url("'+vtxPath+c[h]+'.woff") format("woff"); }\r\n';e.innerHTML+=f;h=0;for(b=c.length;h<b;h++)d[h]=domElement("div",{},{fontFamily:c[h]+', "AdobeBlank"',fontSize:"24px",fontWeight:"normal",color:"transparent",display:"inline-block",border:"0px",padding:"0px",margin:"0px"},"Test 1..2..3.."),document.body.appendChild(d[h]);var k=setInterval(function(){var b,e=c.length;for(b=c.length-1;0<=b;b--)if(12<d[b].offsetWidth){for(a=0;a<vtxFonts.length;a++)if(vtxFonts[a]==c[b]){vtxFontsLoaded[a]=
!0;break}e--}if(0==e){for(b=c.length-1;0<=b;b--)document.body.removeChild(d[b]);clearInterval(k);bootVTX2()}},50)},bootVTX=function(){var a,b=document.getElementsByTagName("head")[0];vtxPath="";var d=document.getElementsByTagName("script");for(a=d.length-1;0<=a;a--)if(0<=d[a].src.toLowerCase().indexOf("vtxclient")){a=d[a].src.split("?")[0];vtxPath=a.split("/").slice(0,-1).join("/")+"/";break}a=domElement("style",{type:"text/css",id:"vtxfonts"},{},'@font-face { \n  font-family: "AdobeBlank";   src: url("'+
vtxPath+'AdobeBlank.woff") format("woff"); }\n');b.appendChild(a);var c=domElement("div",{},{fontFamily:'"AdobeBlank", sans-serif',fontSize:"24px",fontWeight:"normal",color:"transparent",display:"inline-block",border:"0px",padding:"0px",margin:"0px"},"Test 1..2..3..");document.body.appendChild(c);var e=setInterval(function(){32>c.offsetWidth&&(document.body.removeChild(c),clearInterval(e),bootVTX1())},50)},between=function(a,b,d){return b<=a&&a<=d},minMax=function(a,b,d,c){c=void 0===c?null:c;null==
c?(a<b&&(a=b),a>d&&(a=d)):(a<b&&(a=c),a>d&&(a=c));return a},int=function(a){return parseInt(a,10)},domElement=function(a,b,d,c){b=void 0===b?null:b;d=void 0===d?null:d;c=void 0===c?null:c;a=document.createElement(a);var e;if(b)for(e in b)a[e]=b[e];if(d)for(e in d)a.style[e]=d[e];c&&a.appendChild(document.createTextNode(c));return a},addListener=function(a,b,d){a.addEventListener?a.addEventListener(b,d,!1):a.attachEvent("on"+b,d)},ansiColors="transparent #AA0000 #00AA00 #AA5500 #0000AA #AA00AA #00AAAA #AAAAAA #555555 #FF5555 #55FF55 #FFFF55 #5555FF #FF55FF #55FFFF #FFFFFF #000000 #00005F #000087 #0000AF #0000D7 #0000FF #005F00 #005F5F #005F87 #005FAF #005FD7 #005FFF #008700 #00875F #008787 #0087AF #0087D7 #0087FF #00AF00 #00AF5F #00AF87 #00AFAF #00AFD7 #00AFFF #00D700 #00D75F #00D787 #00D7AF #00D7D7 #00D7FF #00FF00 #00FF5F #00FF87 #00FFAF #00FFD7 #00FFFF #5F0000 #5F005F #5F0087 #5F00AF #5F00D7 #5F00FF #5F5F00 #5F5F5F #5F5F87 #5F5FAF #5F5FD7 #5F5FFF #5F8700 #5F875F #5F8787 #5F87AF #5F87D7 #5F87FF #5FAF00 #5FAF5F #5FAF87 #5FAFAF #5FAFD7 #5FAFFF #5FD700 #5FD75F #5FD787 #5FD7AF #5FD7D7 #5FD7FF #5FFF00 #5FFF5F #5FFF87 #5FFFAF #5FFFD7 #5FFFFF #870000 #87005F #870087 #8700AF #8700D7 #8700FF #875F00 #875F5F #875F87 #875FAF #875FD7 #875FFF #878700 #87875F #878787 #8787AF #8787D7 #8787FF #87AF00 #87AF5F #87AF87 #87AFAF #87AFD7 #87AFFF #87D700 #87D75F #87D787 #87D7AF #87D7D7 #87D7FF #87FF00 #87FF5F #87FF87 #87FFAF #87FFD7 #87FFFF #AF0000 #AF005F #AF0087 #AF00AF #AF00D7 #AF00FF #AF5F00 #AF5F5F #AF5F87 #AF5FAF #AF5FD7 #AF5FFF #AF8700 #AF875F #AF8787 #AF87AF #AF87D7 #AF87FF #AFAF00 #AFAF5F #AFAF87 #AFAFAF #AFAFD7 #AFAFFF #AFD700 #AFD75F #AFD787 #AFD7AF #AFD7D7 #AFD7FF #AFFF00 #AFFF5F #AFFF87 #AFFFAF #AFFFD7 #AFFFFF #D70000 #D7005F #D70087 #D700AF #D700D7 #D700FF #D75F00 #D75F5F #D75F87 #D75FAF #D75FD7 #D75FFF #D78700 #D7875F #D78787 #D787AF #D787D7 #D787FF #D7AF00 #D7AF5F #D7AF87 #D7AFAF #D7AFD7 #D7AFFF #D7D700 #D7D75F #D7D787 #D7D7AF #D7D7D7 #D7D7FF #D7FF00 #D7FF5F #D7FF87 #D7FFAF #D7FFD7 #D7FFFF #FF0000 #FF005F #FF0087 #FF00AF #FF00D7 #FF00FF #FF5F00 #FF5F5F #FF5F87 #FF5FAF #FF5FD7 #FF5FFF #FF8700 #FF875F #FF8787 #FF87AF #FF87D7 #FF87FF #FFAF00 #FFAF5F #FFAF87 #FFAFAF #FFAFD7 #FFAFFF #FFD700 #FFD75F #FFD787 #FFD7AF #FFD7D7 #FFD7FF #FFFF00 #FFFF5F #FFFF87 #FFFFAF #FFFFD7 #FFFFFF #080808 #121212 #1C1C1C #262626 #303030 #3A3A3A #444444 #4E4E4E #585858 #626262 #6C6C6C #767676 #808080 #8A8A8A #949494 #9E9E9E #A8A8A8 #B2B2B2 #BCBCBC #C6C6C6 #D0D0D0 #DADADA #E4E4E4 #EEEEEE".split(" "),
