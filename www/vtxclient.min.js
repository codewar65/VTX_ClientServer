...
"hidden",setTimers(!1),document.body.style.cursor="wait"):(pageDiv.classList.remove("fade"),ovl.dialog&&document.body.removeChild(ovl.dialog),ovl={},document.getElementById("ulbtn").style.visibility="visible",document.getElementById("dlbtn").style.visibility="visible",setTimers(!0),document.body.style.cursor="default")},UFT8ArrayToStr=function(a){var b;var d="";var c=a.length;for(b=0;b<c;){var e=a[b++];switch(e>>>4){case 0:case 1:case 2:case 3:case 4:case 5:case 6:case 7:d+=String.fromCharCode(e);
break;case 12:case 13:var f=a[b++];d+=String.fromCharCode((e&31)<<6|f&63);break;case 14:f=a[b++];var h=a[b++];d+=String.fromCharCode((e&15)<<12|(f&63)<<6|(h&63)<<0)}}return d},initDisplay=function(){var a;hotspotHoverAttr=524543;hotspotClickAttr=255;if(a=document.getElementById("vtxclient")){pageDiv=domElement("div",{id:"vtxpage",className:"noselect"});textDiv=domElement("div",{id:"vtxtext",className:"noselect"});pageDiv.appendChild(textDiv);a.appendChild(pageDiv);textPos=getElementPosition(textDiv);
...
TS_OFFLINE;setBulbs()},ws.onerror=function(a){cbm?conBufferOut("\r\rERROR : "+a.reason.toUpper()+"\r"):atari?conBufferOut("\u009b\u009bError : "+a.reason()+"\tB"):conBufferOut("\r\n\r\n\u001b[#9\u001b[0;91mError : "+a.reason+"\r\n");setBulbs()}):ws.close()},newCrsr=function(){var a=["0%","10%","25%","100%"];if(null==crsr){crsr=domElement("div",{},{position:"absolute",display:"block",zIndex:"999"});var b=domElement("div",{id:"crsr"},{position:"absolute",display:"block",bottom:"0px",left:"0px"});crsr.appendChild(b);
pageDiv.appendChild(crsr)}else b=crsr.firstChild;var d=getCrsrAttrOrientation(crsrAttr);var c=getCrsrAttrSize(crsrAttr);switch(d){case 0:b.style.width="100%";b.style.height=a[c];break;default:b.style.height="100%",b.style.width=a[c]}a=getCrsrAttrColor(crsrAttr);b.style["background-color"]=cbm?cbmColors[a&15]:atari?atariColors[a&1]:ansiColors[a]},paste=function(a){a=a||window.event;a.stopPropagation();a.preventDefault();conBufferOut((a.clipboardData||window.clipboardData).getData("Text"))},beforePaste=
function(a){a.returnValue=!1},setTimers=function(a){a?(null==irqWriteBuffer&&(irqWriteBuffer=setInterval(doWriteBuffer,33)),null==irqCheckResize&&(irqCheckResize=setInterval(doCheckResize,10)),null==irqCursor&&(irqCursor=setInterval(doCursor,533)),null==irqBlink&&(irqBlink=setInterval(doBlink,533))):(null!=irqWriteBuffer&&clearInterval(irqWriteBuffer),null!=irqCheckResize&&clearInterval(irqCheckResize),null!=irqCursor&&clearInterval(irqCursor),null!=irqBlink&&clearInterval(irqBlink),irqBlink=irqCursor=
irqCheckResize=irqWriteBuffer=null)},setBulbs=function(){var a=document.getElementById("osbulb");termState==TS_OFFLINE?(a.src=vtxPath+"os0.png",a.title="Connect"):(a.src=vtxPath+"os1.png",a.title="Disconnect");document.getElementById("clbulb").src=vtxPath+(capState?"cl1":"cl0")+".png";document.getElementById("nlbulb").src=vtxPath+(numState?"nl1":"nl0")+".png";document.getElementById("slbulb").src=vtxPath+(scrState?"sl1":"sl0")+".png";termState==TS_NORMAL?(a=document.getElementById("ulbtn"),a.src=
vtxPath+"ul1.png",a.style.visibility="visible",a=document.getElementById("dlbtn"),a.src=vtxPath+"dl1.png",a.style.visibility="visible"):termState==TS_OFFLINE?(a=document.getElementById("ulbtn"),a.src=vtxPath+"ul0.png",a.style.visibility="visible",a=document.getElementById("dlbtn"),a.src=vtxPath+"dl0.png",a.style.visibility="visible"):(document.getElementById("ulbtn").style.visibility="hidden",document.getElementById("dlbtn").style.visibility="hidden")},fitSVGToDiv=function(a){var b=this.parentNode.getBoundingClientRect();
...
ctrlState=a.ctrlKey;altState=a.altKey},mouseUp=function(a){a=a||window.event;shiftState=a.shiftKey;ctrlState=a.ctrlKey;altState=a.altKey},getHotSpot=function(a){var b;if(b=getMouseCell(a))for(a=0;a<conHotSpots.length;a++){var d=conHotSpots[a];if(between(b.row,d.row,d.row+d.height-1)&&between(b.col,d.col,d.col+d.width-1))return conHotSpots[a]}return null},getMouseCell=function(a){var b=document.documentElement.scrollTop||document.body.scrollTop;var d=a.clientX;b=a.clientY+b;var c=textPos.top;if(b>=
c&&between(d,textPos.left,textPos.left+crtWidth-1))for(a=0;a<conRowAttr.length;a++){var e=getRowAttrHeight(conRowAttr[a])/100;var f=getRowAttrWidth(conRowAttr[a])/100;e=Math.round(fontSize*e);if(between(b,c,c+e-1))return d=(d-textPos.left)/(xScale*colSize*f),{row:a,col:Math.floor(d)};c+=e}return null},redrawFont=function(a){var b,d;a=conFont.indexOf(a);if(0<=a)for(b=conRowAttr.length-1;0<=b;b--)for(d=conCellAttr[b].length-1;0<=d;d--){var c=(conCellAttr[b][d]&A_CELL_FONT_MASK)>>>28;c==a&&renderCell(b,
d,0,!1)}},loadSingleFont=function(a){var b,d=document.getElementsByTagName("head")[0];var c=vtxFonts.indexOf(a);if(0<=c&&!vtxFontsLoaded[c]){var e='@font-face {\r\n   font-family: "'+a+'";   src: url("'+vtxPath+a+'.woff") format("woff"); }\r\n';(b=document.getElementById("vtxfonts"))?b.innerHTML+=e:b=domElement("style",{type:"text/css"},{},e);d.appendChild(b);var f=domElement("div",{},{fontFamily:a+', "AdobeBlank"',fontSize:"24px",fontWeight:"normal",color:"transparent",display:"inline-block",border:"0px",
