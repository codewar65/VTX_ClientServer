...
bdf2svg -i teletext2x3.bdf           -o teletext2x3.svg
bdf2svg -i teletext2x3s.bdf          -o teletext2x3s.svg
...
"c:\program files (x86)\FontForgeBuilds\bin\fontforge.exe" -script conv.pe teletext2x3.svg
"c:\program files (x86)\FontForgeBuilds\bin\fontforge.exe" -script conv.pe teletext2x3s.svg
